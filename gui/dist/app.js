...
`)+`
`+c);const v=_+m+o,y=_+c+a,A=Um(r,r.VERTEX_SHADER,v),R=Um(r,r.FRAGMENT_SHADER,y);r.attachShader(x,A),r.attachShader(x,R),n.index0AttributeName!==void 0?r.bindAttribLocation(x,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function C(D){if(t.debug.checkShaderErrors){const k=r.getProgramInfoLog(x)||"",z=r.getShaderInfoLog(A)||"",J=r.getShaderInfoLog(R)||"",j=k.trim(),V=z.trim(),q=J.trim();let b=!0,X=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(b=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,x,A,R);else{const K=Om(r,A,"vertex"),ie=Om(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
