 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(N,q){var Q=N.length;N.push(q);e:for(;0<Q;){var ge=Q-1>>>1,Pe=N[ge];if(0<r(Pe,q))N[ge]=q,N[Q]=Pe,Q=ge;else break e}}function n(N){return N.length===0?null:N[0]}function i(N){if(N.length===0)return null;var q=N[0],Q=N.pop();if(Q!==q){N[0]=Q;e:for(var ge=0,Pe=N.length,je=Pe>>>1;ge<je;){var Fe=2*(ge+1)-1,$e=N[Fe],j=Fe+1,se=N[j];if(0>r($e,Q))j<Pe&&0>r(se,$e)?(N[ge]=se,N[j]=Q,ge=j):(N[ge]=$e,N[Fe]=Q,ge=Fe);else if(j<Pe&&0>r(se,Q))N[ge]=se,N[j]=Q,ge=j;else break e}}return q}function r(N,q){var Q=N.sortIndex-q.sortIndex;return Q!==0?Q:N.id-q.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],f=1,h=null,d=3,p=!1,g=!1,x=!1,m=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,v=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function _(N){for(var q=n(u);q!==null;){if(q.callback===null)i(u);else if(q.startTime<=N)i(u),q.sortIndex=q.expirationTime,e(l,q);else break;q=n(u)}}function y(N){if(x=!1,_(N),!g)if(n(l)!==null)g=!0,Y(R);else{var q=n(u);q!==null&&J(y,q.startTime-N)}}function R(N,q){g=!1,x&&(x=!1,c(P),P=-1),p=!0;var Q=d;try{for(_(q),h=n(l);h!==null&&(!(h.expirationTime>q)||N&&!L());){var ge=h.callback;if(typeof ge=="function"){h.callback=null,d=h.priorityLevel;var Pe=ge(h.expirationTime<=q);q=t.unstable_now(),typeof Pe=="function"?h.callback=Pe:h===n(l)&&i(l),_(q)}else i(l);h=n(l)}if(h!==null)var je=!0;else{var Fe=n(u);Fe!==null&&J(y,Fe.startTime-q),je=!1}return je}finally{h=null,d=Q,p=!1}}var C=!1,A=null,P=-1,T=5,M=-1;function L(){return!(t.unstable_now()-M<T)}function B(){if(A!==null){var N=t.unstable_now();M=N;var q=!0;try{q=A(!0,N)}finally{q?W():(C=!1,A=null)}}else C=!1}var W;if(typeof v=="function")W=function(){v(B)};else if(typeof MessageChannel<"u"){var te=new MessageChannel,X=te.port2;te.port1.onmessage=B,W=function(){X.postMessage(null)}}else W=function(){m(B,0)};function Y(N){A=N,C||(C=!0,W())}function J(N,q){P=m(function(){N(t.unstable_now())},q)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(N){N.callback=null},t.unstable_continueExecution=function(){g||p||(g=!0,Y(R))},t.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<N?Math.floor(1e3/N):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(N){switch(d){case 1:case 2:case 3:var q=3;break;default:q=d}var Q=d;d=q;try{return N()}finally{d=Q}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(N,q){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var Q=d;d=N;try{return q()}finally{d=Q}},t.unstable_scheduleCallback=function(N,q,Q){var ge=t.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?ge+Q:ge):Q=ge,N){case 1:var Pe=-1;break;case 2:Pe=250;break;case 5:Pe=1073741823;break;case 4:Pe=1e4;break;default:Pe=5e3}return Pe=Q+Pe,N={id:f++,callback:q,priorityLevel:N,startTime:Q,expirationTime:Pe,sortIndex:-1},Q>ge?(N.sortIndex=Q,e(u,N),n(l)===null&&N===n(u)&&(x?(c(P),P=-1):x=!0,J(y,Q-ge))):(N.sortIndex=Pe,e(l,N),g||p||(g=!0,Y(R))),N},t.unstable_shouldYield=L,t.unstable_wrapCallback=function(N){var q=d;return function(){var Q=d;d=q;try{return N.apply(this,arguments)}finally{d=Q}}}})(Lg);Pg.exports=Lg;var X0=Pg.exports;/**
 * @license React
...
}`;function DA(t,e,n){let i=new Gd;const r=new fe,s=new fe,o=new Lt,a=new eE({depthPacking:CS}),l=new tE,u={},f=n.maxTextureSize,h={[pr]:yn,[yn]:pr,[bi]:bi},d=new mr({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new fe},radius:{value:4}},vertexShader:PA,fragmentShader:LA}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const g=new In;g.setAttribute("position",new Sn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new mi(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Pv;let c=this.type;this.render=function(C,A,P){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||C.length===0)return;const T=t.getRenderTarget(),M=t.getActiveCubeFace(),L=t.getActiveMipmapLevel(),B=t.state;B.setBlending(cr),B.buffers.depth.getReversed()===!0?B.buffers.color.setClear(0,0,0,0):B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);const W=c!==Ai&&this.type===Ai,te=c===Ai&&this.type!==Ai;for(let X=0,Y=C.length;X<Y;X++){const J=C[X],N=J.shadow;if(N===void 0){console.warn("THREE.WebGLShadowMap:",J,"has no shadow.");continue}if(N.autoUpdate===!1&&N.needsUpdate===!1)continue;r.copy(N.mapSize);const q=N.getFrameExtents();if(r.multiply(q),s.copy(N.mapSize),(r.x>f||r.y>f)&&(r.x>f&&(s.x=Math.floor(f/q.x),r.x=s.x*q.x,N.mapSize.x=s.x),r.y>f&&(s.y=Math.floor(f/q.y),r.y=s.y*q.y,N.mapSize.y=s.y)),N.map===null||W===!0||te===!0){const ge=this.type!==Ai?{minFilter:oi,magFilter:oi}:{};N.map!==null&&N.map.dispose(),N.map=new qr(r.x,r.y,ge),N.map.texture.name=J.name+".shadowMap",N.camera.updateProjectionMatrix()}t.setRenderTarget(N.map),t.clear();const Q=N.getViewportCount();for(let ge=0;ge<Q;ge++){const Pe=N.getViewport(ge);o.set(s.x*Pe.x,s.y*Pe.y,s.x*Pe.z,s.y*Pe.w),B.viewport(o),N.updateMatrices(J,ge),i=N.getFrustum(),y(A,P,N.camera,J,this.type)}N.isPointLightShadow!==!0&&this.type===Ai&&v(N,P),N.needsUpdate=!1}c=this.type,m.needsUpdate=!1,t.setRenderTarget(T,M,L)};function v(C,A){const P=e.update(x);d.defines.VSM_SAMPLES!==C.blurSamples&&(d.defines.VSM_SAMPLES=C.blurSamples,p.defines.VSM_SAMPLES=C.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new qr(r.x,r.y)),d.uniforms.shadow_pass.value=C.map.texture,d.uniforms.resolution.value=C.mapSize,d.uniforms.radius.value=C.radius,t.setRenderTarget(C.mapPass),t.clear(),t.renderBufferDirect(A,null,P,d,x,null),p.uniforms.shadow_pass.value=C.mapPass.texture,p.uniforms.resolution.value=C.mapSize,p.uniforms.radius.value=C.radius,t.setRenderTarget(C.map),t.clear(),t.renderBufferDirect(A,null,P,p,x,null)}function _(C,A,P,T){let M=null;const L=P.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(L!==void 0)M=L;else if(M=P.isPointLight===!0?l:a,t.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0||A.alphaToCoverage===!0){const B=M.uuid,W=A.uuid;let te=u[B];te===void 0&&(te={},u[B]=te);let X=te[W];X===void 0&&(X=M.clone(),te[W]=X,A.addEventListener("dispose",R)),M=X}if(M.visible=A.visible,M.wireframe=A.wireframe,T===Ai?M.side=A.shadowSide!==null?A.shadowSide:A.side:M.side=A.shadowSide!==null?A.shadowSide:h[A.side],M.alphaMap=A.alphaMap,M.alphaTest=A.alphaToCoverage===!0?.5:A.alphaTest,M.map=A.map,M.clipShadows=A.clipShadows,M.clippingPlanes=A.clippingPlanes,M.clipIntersection=A.clipIntersection,M.displacementMap=A.displacementMap,M.displacementScale=A.displacementScale,M.displacementBias=A.displacementBias,M.wireframeLinewidth=A.wireframeLinewidth,M.linewidth=A.linewidth,P.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const B=t.properties.get(M);B.light=P}return M}function y(C,A,P,T,M){if(C.visible===!1)return;if(C.layers.test(A.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&M===Ai)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(P.matrixWorldInverse,C.matrixWorld);const W=e.update(C),te=C.material;if(Array.isArray(te)){const X=W.groups;for(let Y=0,J=X.length;Y<J;Y++){const N=X[Y],q=te[N.materialIndex];if(q&&q.visible){const Q=_(C,q,T,M);C.onBeforeShadow(t,C,A,P,W,Q,N),t.renderBufferDirect(P,null,W,Q,C,N),C.onAfterShadow(t,C,A,P,W,Q,N)}}}else if(te.visible){const X=_(C,te,T,M);C.onBeforeShadow(t,C,A,P,W,X,null),t.renderBufferDirect(P,null,W,X,C,null),C.onAfterShadow(t,C,A,P,W,X,null)}}const B=C.children;for(let W=0,te=B.length;W<te;W++)y(B[W],A,P,T,M)}function R(C){C.target.removeEventListener("dispose",R);for(const P in u){const T=u[P],M=C.target.uuid;M in T&&(T[M].dispose(),delete T[M])}}}const NA={[qf]:$f,[Kf]:Qf,[Zf]:eh,[Js]:Jf,[$f]:qf,[Qf]:Kf,[eh]:Zf,[Jf]:Js};function IA(t,e){function n(){let D=!1;const ae=new Lt;let me=null;const ye=new Lt(0,0,0,0);return{setMask:function(re){me!==re&&!D&&(t.colorMask(re,re,re,re),me=re)},setLocked:function(re){D=re},setClear:function(re,$,we,ze,tt){tt===!0&&(re*=ze,$*=ze,we*=ze),ae.set(re,$,we,ze),ye.equals(ae)===!1&&(t.clearColor(re,$,we,ze),ye.copy(ae))},reset:function(){D=!1,me=null,ye.set(-1,0,0,0)}}}function i(){let D=!1,ae=!1,me=null,ye=null,re=null;return{setReversed:function($){if(ae!==$){const we=e.get("EXT_clip_control");$?we.clipControlEXT(we.LOWER_LEFT_EXT,we.ZERO_TO_ONE_EXT):we.clipControlEXT(we.LOWER_LEFT_EXT,we.NEGATIVE_ONE_TO_ONE_EXT),ae=$;const ze=re;re=null,this.setClear(ze)}},getReversed:function(){return ae},setTest:function($){$?se(t.DEPTH_TEST):Te(t.DEPTH_TEST)},setMask:function($){me!==$&&!D&&(t.depthMask($),me=$)},setFunc:function($){if(ae&&($=NA[$]),ye!==$){switch($){case qf:t.depthFunc(t.NEVER);break;case $f:t.depthFunc(t.ALWAYS);break;case Kf:t.depthFunc(t.LESS);break;case Js:t.depthFunc(t.LEQUAL);break;case Zf:t.depthFunc(t.EQUAL);break;case Jf:t.depthFunc(t.GEQUAL);break;case Qf:t.depthFunc(t.GREATER);break;case eh:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}ye=$}},setLocked:function($){D=$},setClear:function($){re!==$&&(ae&&($=1-$),t.clearDepth($),re=$)},reset:function(){D=!1,me=null,ye=null,re=null,ae=!1}}}function r(){let D=!1,ae=null,me=null,ye=null,re=null,$=null,we=null,ze=null,tt=null;return{setTest:function(Qe){D||(Qe?se(t.STENCIL_TEST):Te(t.STENCIL_TEST))},setMask:function(Qe){ae!==Qe&&!D&&(t.stencilMask(Qe),ae=Qe)},setFunc:function(Qe,Ye,ke){(me!==Qe||ye!==Ye||re!==ke)&&(t.stencilFunc(Qe,Ye,ke),me=Qe,ye=Ye,re=ke)},setOp:function(Qe,Ye,ke){($!==Qe||we!==Ye||ze!==ke)&&(t.stencilOp(Qe,Ye,ke),$=Qe,we=Ye,ze=ke)},setLocked:function(Qe){D=Qe},setClear:function(Qe){tt!==Qe&&(t.clearStencil(Qe),tt=Qe)},reset:function(){D=!1,ae=null,me=null,ye=null,re=null,$=null,we=null,ze=null,tt=null}}}const s=new n,o=new i,a=new r,l=new WeakMap,u=new WeakMap;let f={},h={},d=new WeakMap,p=[],g=null,x=!1,m=null,c=null,v=null,_=null,y=null,R=null,C=null,A=new it(0,0,0),P=0,T=!1,M=null,L=null,B=null,W=null,te=null;const X=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Y=!1,J=0;const N=t.getParameter(t.VERSION);N.indexOf("WebGL")!==-1?(J=parseFloat(/^WebGL (\d)/.exec(N)[1]),Y=J>=1):N.indexOf("OpenGL ES")!==-1&&(J=parseFloat(/^OpenGL ES (\d)/.exec(N)[1]),Y=J>=2);let q=null,Q={};const ge=t.getParameter(t.SCISSOR_BOX),Pe=t.getParameter(t.VIEWPORT),je=new Lt().fromArray(ge),Fe=new Lt().fromArray(Pe);function $e(D,ae,me,ye){const re=new Uint8Array(4),$=t.createTexture();t.bindTexture(D,$),t.texParameteri(D,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(D,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let we=0;we<me;we++)D===t.TEXTURE_3D||D===t.TEXTURE_2D_ARRAY?t.texImage3D(ae,0,t.RGBA,1,1,ye,0,t.RGBA,t.UNSIGNED_BYTE,re):t.texImage2D(ae+we,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,re);return $}const j={};j[t.TEXTURE_2D]=$e(t.TEXTURE_2D,t.TEXTURE_2D,1),j[t.TEXTURE_CUBE_MAP]=$e(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),j[t.TEXTURE_2D_ARRAY]=$e(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),j[t.TEXTURE_3D]=$e(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),se(t.DEPTH_TEST),o.setFunc(Js),K(!1),Z(rm),se(t.CULL_FACE),ne(cr);function se(D){f[D]!==!0&&(t.enable(D),f[D]=!0)}function Te(D){f[D]!==!1&&(t.disable(D),f[D]=!1)}function Oe(D,ae){return h[D]!==ae?(t.bindFramebuffer(D,ae),h[D]=ae,D===t.DRAW_FRAMEBUFFER&&(h[t.FRAMEBUFFER]=ae),D===t.FRAMEBUFFER&&(h[t.DRAW_FRAMEBUFFER]=ae),!0):!1}function Ae(D,ae){let me=p,ye=!1;if(D){me=d.get(ae),me===void 0&&(me=[],d.set(ae,me));const re=D.textures;if(me.length!==re.length||me[0]!==t.COLOR_ATTACHMENT0){for(let $=0,we=re.length;$<we;$++)me[$]=t.COLOR_ATTACHMENT0+$;me.length=re.length,ye=!0}}else me[0]!==t.BACK&&(me[0]=t.BACK,ye=!0);ye&&t.drawBuffers(me)}function Je(D){return g!==D?(t.useProgram(D),g=D,!0):!1}const rt={[Dr]:t.FUNC_ADD,[eS]:t.FUNC_SUBTRACT,[tS]:t.FUNC_REVERSE_SUBTRACT};rt[nS]=t.MIN,rt[iS]=t.MAX;const b={[rS]:t.ZERO,[sS]:t.ONE,[oS]:t.SRC_COLOR,[Yf]:t.SRC_ALPHA,[hS]:t.SRC_ALPHA_SATURATE,[cS]:t.DST_COLOR,[lS]:t.DST_ALPHA,[aS]:t.ONE_MINUS_SRC_COLOR,[jf]:t.ONE_MINUS_SRC_ALPHA,[fS]:t.ONE_MINUS_DST_COLOR,[uS]:t.ONE_MINUS_DST_ALPHA,[dS]:t.CONSTANT_COLOR,[pS]:t.ONE_MINUS_CONSTANT_COLOR,[mS]:t.CONSTANT_ALPHA,[gS]:t.ONE_MINUS_CONSTANT_ALPHA};function ne(D,ae,me,ye,re,$,we,ze,tt,Qe){if(D===cr){x===!0&&(Te(t.BLEND),x=!1);return}if(x===!1&&(se(t.BLEND),x=!0),D!==Qy){if(D!==m||Qe!==T){if((c!==Dr||y!==Dr)&&(t.blendEquation(t.FUNC_ADD),c=Dr,y=Dr),Qe)switch(D){case Gs:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case sm:t.blendFunc(t.ONE,t.ONE);break;case om:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case am:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case Gs:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case sm:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case om:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case am:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}v=null,_=null,R=null,C=null,A.set(0,0,0),P=0,m=D,T=Qe}return}re=re||ae,$=$||me,we=we||ye,(ae!==c||re!==y)&&(t.blendEquationSeparate(rt[ae],rt[re]),c=ae,y=re),(me!==v||ye!==_||$!==R||we!==C)&&(t.blendFuncSeparate(b[me],b[ye],b[$],b[we]),v=me,_=ye,R=$,C=we),(ze.equals(A)===!1||tt!==P)&&(t.blendColor(ze.r,ze.g,ze.b,tt),A.copy(ze),P=tt),m=D,T=!1}function ee(D,ae){D.side===bi?Te(t.CULL_FACE):se(t.CULL_FACE);let me=D.side===yn;ae&&(me=!me),K(me),D.blending===Gs&&D.transparent===!1?ne(cr):ne(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),o.setFunc(D.depthFunc),o.setTest(D.depthTest),o.setMask(D.depthWrite),s.setMask(D.colorWrite);const ye=D.stencilWrite;a.setTest(ye),ye&&(a.setMask(D.stencilWriteMask),a.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),a.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),le(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?se(t.SAMPLE_ALPHA_TO_COVERAGE):Te(t.SAMPLE_ALPHA_TO_COVERAGE)}function K(D){M!==D&&(D?t.frontFace(t.CW):t.frontFace(t.CCW),M=D)}function Z(D){D!==Ky?(se(t.CULL_FACE),D!==L&&(D===rm?t.cullFace(t.BACK):D===Zy?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):Te(t.CULL_FACE),L=D}function _e(D){D!==B&&(Y&&t.lineWidth(D),B=D)}function le(D,ae,me){D?(se(t.POLYGON_OFFSET_FILL),(W!==ae||te!==me)&&(t.polygonOffset(ae,me),W=ae,te=me)):Te(t.POLYGON_OFFSET_FILL)}function ve(D){D?se(t.SCISSOR_TEST):Te(t.SCISSOR_TEST)}function Xe(D){D===void 0&&(D=t.TEXTURE0+X-1),q!==D&&(t.activeTexture(D),q=D)}function Ve(D,ae,me){me===void 0&&(q===null?me=t.TEXTURE0+X-1:me=q);let ye=Q[me];ye===void 0&&(ye={type:void 0,texture:void 0},Q[me]=ye),(ye.type!==D||ye.texture!==ae)&&(q!==me&&(t.activeTexture(me),q=me),t.bindTexture(D,ae||j[D]),ye.type=D,ye.texture=ae)}function w(){const D=Q[q];D!==void 0&&D.type!==void 0&&(t.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function S(){try{t.compressedTexImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function k(){try{t.compressedTexImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function G(){try{t.texSubImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function F(){try{t.texSubImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function U(){try{t.compressedTexSubImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function he(){try{t.compressedTexSubImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function oe(){try{t.texStorage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ee(){try{t.texStorage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function xe(){try{t.texImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ie(){try{t.texImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function de(D){je.equals(D)===!1&&(t.scissor(D.x,D.y,D.z,D.w),je.copy(D))}function Le(D){Fe.equals(D)===!1&&(t.viewport(D.x,D.y,D.z,D.w),Fe.copy(D))}function Ce(D,ae){let me=u.get(ae);me===void 0&&(me=new WeakMap,u.set(ae,me));let ye=me.get(D);ye===void 0&&(ye=t.getUniformBlockIndex(ae,D.name),me.set(D,ye))}function pe(D,ae){const ye=u.get(ae).get(D);l.get(ae)!==ye&&(t.uniformBlockBinding(ae,ye,D.__bindingPointIndex),l.set(ae,ye))}function De(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),o.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),f={},q=null,Q={},h={},d=new WeakMap,p=[],g=null,x=!1,m=null,c=null,v=null,_=null,y=null,R=null,C=null,A=new it(0,0,0),P=0,T=!1,M=null,L=null,B=null,W=null,te=null,je.set(0,0,t.canvas.width,t.canvas.height),Fe.set(0,0,t.canvas.width,t.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:se,disable:Te,bindFramebuffer:Oe,drawBuffers:Ae,useProgram:Je,setBlending:ne,setMaterial:ee,setFlipSided:K,setCullFace:Z,setLineWidth:_e,setPolygonOffset:le,setScissorTest:ve,activeTexture:Xe,bindTexture:Ve,unbindTexture:w,compressedTexImage2D:S,compressedTexImage3D:k,texImage2D:xe,texImage3D:ie,updateUBOMapping:Ce,uniformBlockBinding:pe,texStorage2D:oe,texStorage3D:Ee,texSubImage2D:G,texSubImage3D:F,compressedTexSubImage2D:U,compressedTexSubImage3D:he,scissor:de,viewport:Le,reset:De}}function UA(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new fe,f=new WeakMap;let h;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(w,S){return p?new OffscreenCanvas(w,S):gu("canvas")}function x(w,S,k){let G=1;const F=Ve(w);if((F.width>k||F.height>k)&&(G=k/Math.max(F.width,F.height)),G<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const U=Math.floor(G*F.width),he=Math.floor(G*F.height);h===void 0&&(h=g(U,he));const oe=S?g(U,he):h;return oe.width=U,oe.height=he,oe.getContext("2d").drawImage(w,0,0,U,he),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+F.width+"x"+F.height+") to ("+U+"x"+he+")."),oe}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+F.width+"x"+F.height+")."),w;return w}function m(w){return w.generateMipmaps}function c(w){t.generateMipmap(w)}function v(w){return w.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?t.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function _(w,S,k,G,F=!1){if(w!==null){if(t[w]!==void 0)return t[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let U=S;if(S===t.RED&&(k===t.FLOAT&&(U=t.R32F),k===t.HALF_FLOAT&&(U=t.R16F),k===t.UNSIGNED_BYTE&&(U=t.R8)),S===t.RED_INTEGER&&(k===t.UNSIGNED_BYTE&&(U=t.R8UI),k===t.UNSIGNED_SHORT&&(U=t.R16UI),k===t.UNSIGNED_INT&&(U=t.R32UI),k===t.BYTE&&(U=t.R8I),k===t.SHORT&&(U=t.R16I),k===t.INT&&(U=t.R32I)),S===t.RG&&(k===t.FLOAT&&(U=t.RG32F),k===t.HALF_FLOAT&&(U=t.RG16F),k===t.UNSIGNED_BYTE&&(U=t.RG8)),S===t.RG_INTEGER&&(k===t.UNSIGNED_BYTE&&(U=t.RG8UI),k===t.UNSIGNED_SHORT&&(U=t.RG16UI),k===t.UNSIGNED_INT&&(U=t.RG32UI),k===t.BYTE&&(U=t.RG8I),k===t.SHORT&&(U=t.RG16I),k===t.INT&&(U=t.RG32I)),S===t.RGB_INTEGER&&(k===t.UNSIGNED_BYTE&&(U=t.RGB8UI),k===t.UNSIGNED_SHORT&&(U=t.RGB16UI),k===t.UNSIGNED_INT&&(U=t.RGB32UI),k===t.BYTE&&(U=t.RGB8I),k===t.SHORT&&(U=t.RGB16I),k===t.INT&&(U=t.RGB32I)),S===t.RGBA_INTEGER&&(k===t.UNSIGNED_BYTE&&(U=t.RGBA8UI),k===t.UNSIGNED_SHORT&&(U=t.RGBA16UI),k===t.UNSIGNED_INT&&(U=t.RGBA32UI),k===t.BYTE&&(U=t.RGBA8I),k===t.SHORT&&(U=t.RGBA16I),k===t.INT&&(U=t.RGBA32I)),S===t.RGB&&(k===t.UNSIGNED_INT_5_9_9_9_REV&&(U=t.RGB9_E5),k===t.UNSIGNED_INT_10F_11F_11F_REV&&(U=t.R11F_G11F_B10F)),S===t.RGBA){const he=F?pu:lt.getTransfer(G);k===t.FLOAT&&(U=t.RGBA32F),k===t.HALF_FLOAT&&(U=t.RGBA16F),k===t.UNSIGNED_BYTE&&(U=he===ft?t.SRGB8_ALPHA8:t.RGBA8),k===t.UNSIGNED_SHORT_4_4_4_4&&(U=t.RGBA4),k===t.UNSIGNED_SHORT_5_5_5_1&&(U=t.RGB5_A1)}return(U===t.R16F||U===t.R32F||U===t.RG16F||U===t.RG32F||U===t.RGBA16F||U===t.RGBA32F)&&e.get("EXT_color_buffer_float"),U}function y(w,S){let k;return w?S===null||S===Yr||S===ca?k=t.DEPTH24_STENCIL8:S===Di?k=t.DEPTH32F_STENCIL8:S===ua&&(k=t.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===Yr||S===ca?k=t.DEPTH_COMPONENT24:S===Di?k=t.DEPTH_COMPONENT32F:S===ua&&(k=t.DEPTH_COMPONENT16),k}function R(w,S){return m(w)===!0||w.isFramebufferTexture&&w.minFilter!==oi&&w.minFilter!==di?Math.log2(Math.max(S.width,S.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?S.mipmaps.length:1}function C(w){const S=w.target;S.removeEventListener("dispose",C),P(S),S.isVideoTexture&&f.delete(S)}function A(w){const S=w.target;S.removeEventListener("dispose",A),M(S)}function P(w){const S=i.get(w);if(S.__webglInit===void 0)return;const k=w.source,G=d.get(k);if(G){const F=G[S.__cacheKey];F.usedTimes--,F.usedTimes===0&&T(w),Object.keys(G).length===0&&d.delete(k)}i.remove(w)}function T(w){const S=i.get(w);t.deleteTexture(S.__webglTexture);const k=w.source,G=d.get(k);delete G[S.__cacheKey],o.memory.textures--}function M(w){const S=i.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),i.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let G=0;G<6;G++){if(Array.isArray(S.__webglFramebuffer[G]))for(let F=0;F<S.__webglFramebuffer[G].length;F++)t.deleteFramebuffer(S.__webglFramebuffer[G][F]);else t.deleteFramebuffer(S.__webglFramebuffer[G]);S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer[G])}else{if(Array.isArray(S.__webglFramebuffer))for(let G=0;G<S.__webglFramebuffer.length;G++)t.deleteFramebuffer(S.__webglFramebuffer[G]);else t.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&t.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let G=0;G<S.__webglColorRenderbuffer.length;G++)S.__webglColorRenderbuffer[G]&&t.deleteRenderbuffer(S.__webglColorRenderbuffer[G]);S.__webglDepthRenderbuffer&&t.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const k=w.textures;for(let G=0,F=k.length;G<F;G++){const U=i.get(k[G]);U.__webglTexture&&(t.deleteTexture(U.__webglTexture),o.memory.textures--),i.remove(k[G])}i.remove(w)}let L=0;function B(){L=0}function W(){const w=L;return w>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+r.maxTextures),L+=1,w}function te(w){const S=[];return S.push(w.wrapS),S.push(w.wrapT),S.push(w.wrapR||0),S.push(w.magFilter),S.push(w.minFilter),S.push(w.anisotropy),S.push(w.internalFormat),S.push(w.format),S.push(w.type),S.push(w.generateMipmaps),S.push(w.premultiplyAlpha),S.push(w.flipY),S.push(w.unpackAlignment),S.push(w.colorSpace),S.join()}function X(w,S){const k=i.get(w);if(w.isVideoTexture&&ve(w),w.isRenderTargetTexture===!1&&w.isExternalTexture!==!0&&w.version>0&&k.__version!==w.version){const G=w.image;if(G===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(G.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{j(k,w,S);return}}else w.isExternalTexture&&(k.__webglTexture=w.sourceTexture?w.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,k.__webglTexture,t.TEXTURE0+S)}function Y(w,S){const k=i.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&k.__version!==w.version){j(k,w,S);return}n.bindTexture(t.TEXTURE_2D_ARRAY,k.__webglTexture,t.TEXTURE0+S)}function J(w,S){const k=i.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&k.__version!==w.version){j(k,w,S);return}n.bindTexture(t.TEXTURE_3D,k.__webglTexture,t.TEXTURE0+S)}function N(w,S){const k=i.get(w);if(w.version>0&&k.__version!==w.version){se(k,w,S);return}n.bindTexture(t.TEXTURE_CUBE_MAP,k.__webglTexture,t.TEXTURE0+S)}const q={[ih]:t.REPEAT,[Or]:t.CLAMP_TO_EDGE,[rh]:t.MIRRORED_REPEAT},Q={[oi]:t.NEAREST,[AS]:t.NEAREST_MIPMAP_NEAREST,[Ga]:t.NEAREST_MIPMAP_LINEAR,[di]:t.LINEAR,[dc]:t.LINEAR_MIPMAP_NEAREST,[kr]:t.LINEAR_MIPMAP_LINEAR},ge={[PS]:t.NEVER,[FS]:t.ALWAYS,[LS]:t.LESS,[Vv]:t.LEQUAL,[DS]:t.EQUAL,[US]:t.GEQUAL,[NS]:t.GREATER,[IS]:t.NOTEQUAL};function Pe(w,S){if(S.type===Di&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===di||S.magFilter===dc||S.magFilter===Ga||S.magFilter===kr||S.minFilter===di||S.minFilter===dc||S.minFilter===Ga||S.minFilter===kr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(w,t.TEXTURE_WRAP_S,q[S.wrapS]),t.texParameteri(w,t.TEXTURE_WRAP_T,q[S.wrapT]),(w===t.TEXTURE_3D||w===t.TEXTURE_2D_ARRAY)&&t.texParameteri(w,t.TEXTURE_WRAP_R,q[S.wrapR]),t.texParameteri(w,t.TEXTURE_MAG_FILTER,Q[S.magFilter]),t.texParameteri(w,t.TEXTURE_MIN_FILTER,Q[S.minFilter]),S.compareFunction&&(t.texParameteri(w,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(w,t.TEXTURE_COMPARE_FUNC,ge[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===oi||S.minFilter!==Ga&&S.minFilter!==kr||S.type===Di&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||i.get(S).__currentAnisotropy){const k=e.get("EXT_texture_filter_anisotropic");t.texParameterf(w,k.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,r.getMaxAnisotropy())),i.get(S).__currentAnisotropy=S.anisotropy}}}function je(w,S){let k=!1;w.__webglInit===void 0&&(w.__webglInit=!0,S.addEventListener("dispose",C));const G=S.source;let F=d.get(G);F===void 0&&(F={},d.set(G,F));const U=te(S);if(U!==w.__cacheKey){F[U]===void 0&&(F[U]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,k=!0),F[U].usedTimes++;const he=F[w.__cacheKey];he!==void 0&&(F[w.__cacheKey].usedTimes--,he.usedTimes===0&&T(S)),w.__cacheKey=U,w.__webglTexture=F[U].texture}return k}function Fe(w,S,k){return Math.floor(Math.floor(w/k)/S)}function $e(w,S,k,G){const U=w.updateRanges;if(U.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,S.width,S.height,k,G,S.data);else{U.sort((ie,de)=>ie.start-de.start);let he=0;for(let ie=1;ie<U.length;ie++){const de=U[he],Le=U[ie],Ce=de.start+de.count,pe=Fe(Le.start,S.width,4),De=Fe(de.start,S.width,4);Le.start<=Ce+1&&pe===De&&Fe(Le.start+Le.count-1,S.width,4)===pe?de.count=Math.max(de.count,Le.start+Le.count-de.start):(++he,U[he]=Le)}U.length=he+1;const oe=t.getParameter(t.UNPACK_ROW_LENGTH),Ee=t.getParameter(t.UNPACK_SKIP_PIXELS),xe=t.getParameter(t.UNPACK_SKIP_ROWS);t.pixelStorei(t.UNPACK_ROW_LENGTH,S.width);for(let ie=0,de=U.length;ie<de;ie++){const Le=U[ie],Ce=Math.floor(Le.start/4),pe=Math.ceil(Le.count/4),De=Ce%S.width,D=Math.floor(Ce/S.width),ae=pe,me=1;t.pixelStorei(t.UNPACK_SKIP_PIXELS,De),t.pixelStorei(t.UNPACK_SKIP_ROWS,D),n.texSubImage2D(t.TEXTURE_2D,0,De,D,ae,me,k,G,S.data)}w.clearUpdateRanges(),t.pixelStorei(t.UNPACK_ROW_LENGTH,oe),t.pixelStorei(t.UNPACK_SKIP_PIXELS,Ee),t.pixelStorei(t.UNPACK_SKIP_ROWS,xe)}}function j(w,S,k){let G=t.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(G=t.TEXTURE_2D_ARRAY),S.isData3DTexture&&(G=t.TEXTURE_3D);const F=je(w,S),U=S.source;n.bindTexture(G,w.__webglTexture,t.TEXTURE0+k);const he=i.get(U);if(U.version!==he.__version||F===!0){n.activeTexture(t.TEXTURE0+k);const oe=lt.getPrimaries(lt.workingColorSpace),Ee=S.colorSpace===Qi?null:lt.getPrimaries(S.colorSpace),xe=S.colorSpace===Qi||oe===Ee?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,xe);let ie=x(S.image,!1,r.maxTextureSize);ie=Xe(S,ie);const de=s.convert(S.format,S.colorSpace),Le=s.convert(S.type);let Ce=_(S.internalFormat,de,Le,S.colorSpace,S.isVideoTexture);Pe(G,S);let pe;const De=S.mipmaps,D=S.isVideoTexture!==!0,ae=he.__version===void 0||F===!0,me=U.dataReady,ye=R(S,ie);if(S.isDepthTexture)Ce=y(S.format===ha,S.type),ae&&(D?n.texStorage2D(t.TEXTURE_2D,1,Ce,ie.width,ie.height):n.texImage2D(t.TEXTURE_2D,0,Ce,ie.width,ie.height,0,de,Le,null));else if(S.isDataTexture)if(De.length>0){D&&ae&&n.texStorage2D(t.TEXTURE_2D,ye,Ce,De[0].width,De[0].height);for(let re=0,$=De.length;re<$;re++)pe=De[re],D?me&&n.texSubImage2D(t.TEXTURE_2D,re,0,0,pe.width,pe.height,de,Le,pe.data):n.texImage2D(t.TEXTURE_2D,re,Ce,pe.width,pe.height,0,de,Le,pe.data);S.generateMipmaps=!1}else D?(ae&&n.texStorage2D(t.TEXTURE_2D,ye,Ce,ie.width,ie.height),me&&$e(S,ie,de,Le)):n.texImage2D(t.TEXTURE_2D,0,Ce,ie.width,ie.height,0,de,Le,ie.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){D&&ae&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ye,Ce,De[0].width,De[0].height,ie.depth);for(let re=0,$=De.length;re<$;re++)if(pe=De[re],S.format!==ii)if(de!==null)if(D){if(me)if(S.layerUpdates.size>0){const we=Wm(pe.width,pe.height,S.format,S.type);for(const ze of S.layerUpdates){const tt=pe.data.subarray(ze*we/pe.data.BYTES_PER_ELEMENT,(ze+1)*we/pe.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,re,0,0,ze,pe.width,pe.height,1,de,tt)}S.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,re,0,0,0,pe.width,pe.height,ie.depth,de,pe.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,re,Ce,pe.width,pe.height,ie.depth,0,pe.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else D?me&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,re,0,0,0,pe.width,pe.height,ie.depth,de,Le,pe.data):n.texImage3D(t.TEXTURE_2D_ARRAY,re,Ce,pe.width,pe.height,ie.depth,0,de,Le,pe.data)}else{D&&ae&&n.texStorage2D(t.TEXTURE_2D,ye,Ce,De[0].width,De[0].height);for(let re=0,$=De.length;re<$;re++)pe=De[re],S.format!==ii?de!==null?D?me&&n.compressedTexSubImage2D(t.TEXTURE_2D,re,0,0,pe.width,pe.height,de,pe.data):n.compressedTexImage2D(t.TEXTURE_2D,re,Ce,pe.width,pe.height,0,pe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):D?me&&n.texSubImage2D(t.TEXTURE_2D,re,0,0,pe.width,pe.height,de,Le,pe.data):n.texImage2D(t.TEXTURE_2D,re,Ce,pe.width,pe.height,0,de,Le,pe.data)}else if(S.isDataArrayTexture)if(D){if(ae&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ye,Ce,ie.width,ie.height,ie.depth),me)if(S.layerUpdates.size>0){const re=Wm(ie.width,ie.height,S.format,S.type);for(const $ of S.layerUpdates){const we=ie.data.subarray($*re/ie.data.BYTES_PER_ELEMENT,($+1)*re/ie.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,$,ie.width,ie.height,1,de,Le,we)}S.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,ie.width,ie.height,ie.depth,de,Le,ie.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,Ce,ie.width,ie.height,ie.depth,0,de,Le,ie.data);else if(S.isData3DTexture)D?(ae&&n.texStorage3D(t.TEXTURE_3D,ye,Ce,ie.width,ie.height,ie.depth),me&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,ie.width,ie.height,ie.depth,de,Le,ie.data)):n.texImage3D(t.TEXTURE_3D,0,Ce,ie.width,ie.height,ie.depth,0,de,Le,ie.data);else if(S.isFramebufferTexture){if(ae)if(D)n.texStorage2D(t.TEXTURE_2D,ye,Ce,ie.width,ie.height);else{let re=ie.width,$=ie.height;for(let we=0;we<ye;we++)n.texImage2D(t.TEXTURE_2D,we,Ce,re,$,0,de,Le,null),re>>=1,$>>=1}}else if(De.length>0){if(D&&ae){const re=Ve(De[0]);n.texStorage2D(t.TEXTURE_2D,ye,Ce,re.width,re.height)}for(let re=0,$=De.length;re<$;re++)pe=De[re],D?me&&n.texSubImage2D(t.TEXTURE_2D,re,0,0,de,Le,pe):n.texImage2D(t.TEXTURE_2D,re,Ce,de,Le,pe);S.generateMipmaps=!1}else if(D){if(ae){const re=Ve(ie);n.texStorage2D(t.TEXTURE_2D,ye,Ce,re.width,re.height)}me&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,de,Le,ie)}else n.texImage2D(t.TEXTURE_2D,0,Ce,de,Le,ie);m(S)&&c(G),he.__version=U.version,S.onUpdate&&S.onUpdate(S)}w.__version=S.version}function se(w,S,k){if(S.image.length!==6)return;const G=je(w,S),F=S.source;n.bindTexture(t.TEXTURE_CUBE_MAP,w.__webglTexture,t.TEXTURE0+k);const U=i.get(F);if(F.version!==U.__version||G===!0){n.activeTexture(t.TEXTURE0+k);const he=lt.getPrimaries(lt.workingColorSpace),oe=S.colorSpace===Qi?null:lt.getPrimaries(S.colorSpace),Ee=S.colorSpace===Qi||he===oe?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);const xe=S.isCompressedTexture||S.image[0].isCompressedTexture,ie=S.image[0]&&S.image[0].isDataTexture,de=[];for(let $=0;$<6;$++)!xe&&!ie?de[$]=x(S.image[$],!0,r.maxCubemapSize):de[$]=ie?S.image[$].image:S.image[$],de[$]=Xe(S,de[$]);const Le=de[0],Ce=s.convert(S.format,S.colorSpace),pe=s.convert(S.type),De=_(S.internalFormat,Ce,pe,S.colorSpace),D=S.isVideoTexture!==!0,ae=U.__version===void 0||G===!0,me=F.dataReady;let ye=R(S,Le);Pe(t.TEXTURE_CUBE_MAP,S);let re;if(xe){D&&ae&&n.texStorage2D(t.TEXTURE_CUBE_MAP,ye,De,Le.width,Le.height);for(let $=0;$<6;$++){re=de[$].mipmaps;for(let we=0;we<re.length;we++){const ze=re[we];S.format!==ii?Ce!==null?D?me&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+$,we,0,0,ze.width,ze.height,Ce,ze.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+$,we,De,ze.width,ze.height,0,ze.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?me&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+$,we,0,0,ze.width,ze.height,Ce,pe,ze.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+$,we,De,ze.width,ze.height,0,Ce,pe,ze.data)}}}else{if(re=S.mipmaps,D&&ae){re.length>0&&ye++;const $=Ve(de[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,ye,De,$.width,$.height)}for(let $=0;$<6;$++)if(ie){D?me&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,de[$].width,de[$].height,Ce,pe,de[$].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,De,de[$].width,de[$].height,0,Ce,pe,de[$].data);for(let we=0;we<re.length;we++){const tt=re[we].image[$].image;D?me&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+$,we+1,0,0,tt.width,tt.height,Ce,pe,tt.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+$,we+1,De,tt.width,tt.height,0,Ce,pe,tt.data)}}else{D?me&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,Ce,pe,de[$]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,De,Ce,pe,de[$]);for(let we=0;we<re.length;we++){const ze=re[we];D?me&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+$,we+1,0,0,Ce,pe,ze.image[$]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+$,we+1,De,Ce,pe,ze.image[$])}}}m(S)&&c(t.TEXTURE_CUBE_MAP),U.__version=F.version,S.onUpdate&&S.onUpdate(S)}w.__version=S.version}function Te(w,S,k,G,F,U){const he=s.convert(k.format,k.colorSpace),oe=s.convert(k.type),Ee=_(k.internalFormat,he,oe,k.colorSpace),xe=i.get(S),ie=i.get(k);if(ie.__renderTarget=S,!xe.__hasExternalTextures){const de=Math.max(1,S.width>>U),Le=Math.max(1,S.height>>U);F===t.TEXTURE_3D||F===t.TEXTURE_2D_ARRAY?n.texImage3D(F,U,Ee,de,Le,S.depth,0,he,oe,null):n.texImage2D(F,U,Ee,de,Le,0,he,oe,null)}n.bindFramebuffer(t.FRAMEBUFFER,w),le(S)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,G,F,ie.__webglTexture,0,_e(S)):(F===t.TEXTURE_2D||F>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&F<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,G,F,ie.__webglTexture,U),n.bindFramebuffer(t.FRAMEBUFFER,null)}function Oe(w,S,k){if(t.bindRenderbuffer(t.RENDERBUFFER,w),S.depthBuffer){const G=S.depthTexture,F=G&&G.isDepthTexture?G.type:null,U=y(S.stencilBuffer,F),he=S.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,oe=_e(S);le(S)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,oe,U,S.width,S.height):k?t.renderbufferStorageMultisample(t.RENDERBUFFER,oe,U,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,U,S.width,S.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,he,t.RENDERBUFFER,w)}else{const G=S.textures;for(let F=0;F<G.length;F++){const U=G[F],he=s.convert(U.format,U.colorSpace),oe=s.convert(U.type),Ee=_(U.internalFormat,he,oe,U.colorSpace),xe=_e(S);k&&le(S)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,xe,Ee,S.width,S.height):le(S)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,xe,Ee,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,Ee,S.width,S.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Ae(w,S){if(S&&S.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,w),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const G=i.get(S.depthTexture);G.__renderTarget=S,(!G.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),X(S.depthTexture,0);const F=G.__webglTexture,U=_e(S);if(S.depthTexture.format===fa)le(S)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,F,0,U):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,F,0);else if(S.depthTexture.format===ha)le(S)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,F,0,U):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,F,0);else throw new Error("Unknown depthTexture format")}function Je(w){const S=i.get(w),k=w.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==w.depthTexture){const G=w.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),G){const F=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,G.removeEventListener("dispose",F)};G.addEventListener("dispose",F),S.__depthDisposeCallback=F}S.__boundDepthTexture=G}if(w.depthTexture&&!S.__autoAllocateDepthBuffer){if(k)throw new Error("target.depthTexture not supported in Cube render targets");const G=w.texture.mipmaps;G&&G.length>0?Ae(S.__webglFramebuffer[0],w):Ae(S.__webglFramebuffer,w)}else if(k){S.__webglDepthbuffer=[];for(let G=0;G<6;G++)if(n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer[G]),S.__webglDepthbuffer[G]===void 0)S.__webglDepthbuffer[G]=t.createRenderbuffer(),Oe(S.__webglDepthbuffer[G],w,!1);else{const F=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,U=S.__webglDepthbuffer[G];t.bindRenderbuffer(t.RENDERBUFFER,U),t.framebufferRenderbuffer(t.FRAMEBUFFER,F,t.RENDERBUFFER,U)}}else{const G=w.texture.mipmaps;if(G&&G.length>0?n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=t.createRenderbuffer(),Oe(S.__webglDepthbuffer,w,!1);else{const F=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,U=S.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,U),t.framebufferRenderbuffer(t.FRAMEBUFFER,F,t.RENDERBUFFER,U)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function rt(w,S,k){const G=i.get(w);S!==void 0&&Te(G.__webglFramebuffer,w,w.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),k!==void 0&&Je(w)}function b(w){const S=w.texture,k=i.get(w),G=i.get(S);w.addEventListener("dispose",A);const F=w.textures,U=w.isWebGLCubeRenderTarget===!0,he=F.length>1;if(he||(G.__webglTexture===void 0&&(G.__webglTexture=t.createTexture()),G.__version=S.version,o.memory.textures++),U){k.__webglFramebuffer=[];for(let oe=0;oe<6;oe++)if(S.mipmaps&&S.mipmaps.length>0){k.__webglFramebuffer[oe]=[];for(let Ee=0;Ee<S.mipmaps.length;Ee++)k.__webglFramebuffer[oe][Ee]=t.createFramebuffer()}else k.__webglFramebuffer[oe]=t.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){k.__webglFramebuffer=[];for(let oe=0;oe<S.mipmaps.length;oe++)k.__webglFramebuffer[oe]=t.createFramebuffer()}else k.__webglFramebuffer=t.createFramebuffer();if(he)for(let oe=0,Ee=F.length;oe<Ee;oe++){const xe=i.get(F[oe]);xe.__webglTexture===void 0&&(xe.__webglTexture=t.createTexture(),o.memory.textures++)}if(w.samples>0&&le(w)===!1){k.__webglMultisampledFramebuffer=t.createFramebuffer(),k.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,k.__webglMultisampledFramebuffer);for(let oe=0;oe<F.length;oe++){const Ee=F[oe];k.__webglColorRenderbuffer[oe]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,k.__webglColorRenderbuffer[oe]);const xe=s.convert(Ee.format,Ee.colorSpace),ie=s.convert(Ee.type),de=_(Ee.internalFormat,xe,ie,Ee.colorSpace,w.isXRRenderTarget===!0),Le=_e(w);t.renderbufferStorageMultisample(t.RENDERBUFFER,Le,de,w.width,w.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+oe,t.RENDERBUFFER,k.__webglColorRenderbuffer[oe])}t.bindRenderbuffer(t.RENDERBUFFER,null),w.depthBuffer&&(k.__webglDepthRenderbuffer=t.createRenderbuffer(),Oe(k.__webglDepthRenderbuffer,w,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(U){n.bindTexture(t.TEXTURE_CUBE_MAP,G.__webglTexture),Pe(t.TEXTURE_CUBE_MAP,S);for(let oe=0;oe<6;oe++)if(S.mipmaps&&S.mipmaps.length>0)for(let Ee=0;Ee<S.mipmaps.length;Ee++)Te(k.__webglFramebuffer[oe][Ee],w,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Ee);else Te(k.__webglFramebuffer[oe],w,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0);m(S)&&c(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(he){for(let oe=0,Ee=F.length;oe<Ee;oe++){const xe=F[oe],ie=i.get(xe);let de=t.TEXTURE_2D;(w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(de=w.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(de,ie.__webglTexture),Pe(de,xe),Te(k.__webglFramebuffer,w,xe,t.COLOR_ATTACHMENT0+oe,de,0),m(xe)&&c(de)}n.unbindTexture()}else{let oe=t.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(oe=w.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(oe,G.__webglTexture),Pe(oe,S),S.mipmaps&&S.mipmaps.length>0)for(let Ee=0;Ee<S.mipmaps.length;Ee++)Te(k.__webglFramebuffer[Ee],w,S,t.COLOR_ATTACHMENT0,oe,Ee);else Te(k.__webglFramebuffer,w,S,t.COLOR_ATTACHMENT0,oe,0);m(S)&&c(oe),n.unbindTexture()}w.depthBuffer&&Je(w)}function ne(w){const S=w.textures;for(let k=0,G=S.length;k<G;k++){const F=S[k];if(m(F)){const U=v(w),he=i.get(F).__webglTexture;n.bindTexture(U,he),c(U),n.unbindTexture()}}}const ee=[],K=[];function Z(w){if(w.samples>0){if(le(w)===!1){const S=w.textures,k=w.width,G=w.height;let F=t.COLOR_BUFFER_BIT;const U=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,he=i.get(w),oe=S.length>1;if(oe)for(let xe=0;xe<S.length;xe++)n.bindFramebuffer(t.FRAMEBUFFER,he.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+xe,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,he.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+xe,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,he.__webglMultisampledFramebuffer);const Ee=w.texture.mipmaps;Ee&&Ee.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,he.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,he.__webglFramebuffer);for(let xe=0;xe<S.length;xe++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(F|=t.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(F|=t.STENCIL_BUFFER_BIT)),oe){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,he.__webglColorRenderbuffer[xe]);const ie=i.get(S[xe]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,ie,0)}t.blitFramebuffer(0,0,k,G,0,0,k,G,F,t.NEAREST),l===!0&&(ee.length=0,K.length=0,ee.push(t.COLOR_ATTACHMENT0+xe),w.depthBuffer&&w.resolveDepthBuffer===!1&&(ee.push(U),K.push(U),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,K)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,ee))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),oe)for(let xe=0;xe<S.length;xe++){n.bindFramebuffer(t.FRAMEBUFFER,he.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+xe,t.RENDERBUFFER,he.__webglColorRenderbuffer[xe]);const ie=i.get(S[xe]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,he.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+xe,t.TEXTURE_2D,ie,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,he.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&l){const S=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[S])}}}function _e(w){return Math.min(r.maxSamples,w.samples)}function le(w){const S=i.get(w);return w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function ve(w){const S=o.render.frame;f.get(w)!==S&&(f.set(w,S),w.update())}function Xe(w,S){const k=w.colorSpace,G=w.format,F=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||k!==to&&k!==Qi&&(lt.getTransfer(k)===ft?(G!==ii||F!==vi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",k)),S}function Ve(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(u.width=w.naturalWidth||w.width,u.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(u.width=w.displayWidth,u.height=w.displayHeight):(u.width=w.width,u.height=w.height),u}this.allocateTextureUnit=W,this.resetTextureUnits=B,this.setTexture2D=X,this.setTexture2DArray=Y,this.setTexture3D=J,this.setTextureCube=N,this.rebindTextures=rt,this.setupRenderTarget=b,this.updateRenderTargetMipmap=ne,this.updateMultisampleRenderTarget=Z,this.setupDepthRenderbuffer=Je,this.setupFrameBufferTexture=Te,this.useMultisampledRTT=le}function FA(t,e){function n(i,r=Qi){let s;const o=lt.getTransfer(r);if(i===vi)return t.UNSIGNED_BYTE;if(i===Od)return t.UNSIGNED_SHORT_4_4_4_4;if(i===kd)return t.UNSIGNED_SHORT_5_5_5_1;if(i===Uv)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===Fv)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===Nv)return t.BYTE;if(i===Iv)return t.SHORT;if(i===ua)return t.UNSIGNED_SHORT;if(i===Fd)return t.INT;if(i===Yr)return t.UNSIGNED_INT;if(i===Di)return t.FLOAT;if(i===Ma)return t.HALF_FLOAT;if(i===Ov)return t.ALPHA;if(i===kv)return t.RGB;if(i===ii)return t.RGBA;if(i===fa)return t.DEPTH_COMPONENT;if(i===ha)return t.DEPTH_STENCIL;if(i===zv)return t.RED;if(i===zd)return t.RED_INTEGER;if(i===Bv)return t.RG;if(i===Bd)return t.RG_INTEGER;if(i===Hd)return t.RGBA_INTEGER;if(i===zl||i===Bl||i===Hl||i===Vl)if(o===ft)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===zl)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Bl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Hl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Vl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===zl)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Bl)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Hl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Vl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===sh||i===oh||i===ah||i===lh)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===sh)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===oh)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===ah)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===lh)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===uh||i===ch||i===fh)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===uh||i===ch)return o===ft?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===fh)return o===ft?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===hh||i===dh||i===ph||i===mh||i===gh||i===_h||i===vh||i===xh||i===yh||i===Sh||i===Mh||i===Eh||i===Th||i===wh)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===hh)return o===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===dh)return o===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===ph)return o===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===mh)return o===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===gh)return o===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===_h)return o===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===vh)return o===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===xh)return o===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===yh)return o===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Sh)return o===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Mh)return o===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Eh)return o===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Th)return o===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===wh)return o===ft?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Ah||i===Rh||i===Ch)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Ah)return o===ft?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Rh)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Ch)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===bh||i===Ph||i===Lh||i===Dh)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===bh)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Ph)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Lh)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Dh)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===ca?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const OA=`
void main() {
...
}`;class zA{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n){if(this.texture===null){const i=new i0(e.texture);(e.depthNear!==n.depthNear||e.depthFar!==n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,i=new mr({vertexShader:OA,fragmentShader:kA,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new mi(new ku(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class BA extends Jr{constructor(e,n){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,u=null,f=null,h=null,d=null,p=null,g=null;const x=typeof XRWebGLBinding<"u",m=new zA,c={},v=n.getContextAttributes();let _=null,y=null;const R=[],C=[],A=new fe;let P=null;const T=new Vn;T.viewport=new Lt;const M=new Vn;M.viewport=new Lt;const L=[T,M],B=new oE;let W=null,te=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(j){let se=R[j];return se===void 0&&(se=new Uc,R[j]=se),se.getTargetRaySpace()},this.getControllerGrip=function(j){let se=R[j];return se===void 0&&(se=new Uc,R[j]=se),se.getGripSpace()},this.getHand=function(j){let se=R[j];return se===void 0&&(se=new Uc,R[j]=se),se.getHandSpace()};function X(j){const se=C.indexOf(j.inputSource);if(se===-1)return;const Te=R[se];Te!==void 0&&(Te.update(j.inputSource,j.frame,u||o),Te.dispatchEvent({type:j.type,data:j.inputSource}))}function Y(){r.removeEventListener("select",X),r.removeEventListener("selectstart",X),r.removeEventListener("selectend",X),r.removeEventListener("squeeze",X),r.removeEventListener("squeezestart",X),r.removeEventListener("squeezeend",X),r.removeEventListener("end",Y),r.removeEventListener("inputsourceschange",J);for(let j=0;j<R.length;j++){const se=C[j];se!==null&&(C[j]=null,R[j].disconnect(se))}W=null,te=null,m.reset();for(const j in c)delete c[j];e.setRenderTarget(_),p=null,d=null,h=null,r=null,y=null,$e.stop(),i.isPresenting=!1,e.setPixelRatio(P),e.setSize(A.width,A.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(j){s=j,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(j){a=j,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||o},this.setReferenceSpace=function(j){u=j},this.getBaseLayer=function(){return d!==null?d:p},this.getBinding=function(){return h===null&&x&&(h=new XRWebGLBinding(r,n)),h},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(j){if(r=j,r!==null){if(_=e.getRenderTarget(),r.addEventListener("select",X),r.addEventListener("selectstart",X),r.addEventListener("selectend",X),r.addEventListener("squeeze",X),r.addEventListener("squeezestart",X),r.addEventListener("squeezeend",X),r.addEventListener("end",Y),r.addEventListener("inputsourceschange",J),v.xrCompatible!==!0&&await n.makeXRCompatible(),P=e.getPixelRatio(),e.getSize(A),x&&"createProjectionLayer"in XRWebGLBinding.prototype){let Te=null,Oe=null,Ae=null;v.depth&&(Ae=v.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,Te=v.stencil?ha:fa,Oe=v.stencil?ca:Yr);const Je={colorFormat:n.RGBA8,depthFormat:Ae,scaleFactor:s};h=this.getBinding(),d=h.createProjectionLayer(Je),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),y=new qr(d.textureWidth,d.textureHeight,{format:ii,type:vi,depthTexture:new n0(d.textureWidth,d.textureHeight,Oe,void 0,void 0,void 0,void 0,void 0,void 0,Te),stencilBuffer:v.stencil,colorSpace:e.outputColorSpace,samples:v.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const Te={antialias:v.antialias,alpha:!0,depth:v.depth,stencil:v.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,n,Te),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),y=new qr(p.framebufferWidth,p.framebufferHeight,{format:ii,type:vi,colorSpace:e.outputColorSpace,stencilBuffer:v.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(l),u=null,o=await r.requestReferenceSpace(a),$e.setContext(r),$e.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function J(j){for(let se=0;se<j.removed.length;se++){const Te=j.removed[se],Oe=C.indexOf(Te);Oe>=0&&(C[Oe]=null,R[Oe].disconnect(Te))}for(let se=0;se<j.added.length;se++){const Te=j.added[se];let Oe=C.indexOf(Te);if(Oe===-1){for(let Je=0;Je<R.length;Je++)if(Je>=C.length){C.push(Te),Oe=Je;break}else if(C[Je]===null){C[Je]=Te,Oe=Je;break}if(Oe===-1)break}const Ae=R[Oe];Ae&&Ae.connect(Te)}}const N=new I,q=new I;function Q(j,se,Te){N.setFromMatrixPosition(se.matrixWorld),q.setFromMatrixPosition(Te.matrixWorld);const Oe=N.distanceTo(q),Ae=se.projectionMatrix.elements,Je=Te.projectionMatrix.elements,rt=Ae[14]/(Ae[10]-1),b=Ae[14]/(Ae[10]+1),ne=(Ae[9]+1)/Ae[5],ee=(Ae[9]-1)/Ae[5],K=(Ae[8]-1)/Ae[0],Z=(Je[8]+1)/Je[0],_e=rt*K,le=rt*Z,ve=Oe/(-K+Z),Xe=ve*-K;if(se.matrixWorld.decompose(j.position,j.quaternion,j.scale),j.translateX(Xe),j.translateZ(ve),j.matrixWorld.compose(j.position,j.quaternion,j.scale),j.matrixWorldInverse.copy(j.matrixWorld).invert(),Ae[10]===-1)j.projectionMatrix.copy(se.projectionMatrix),j.projectionMatrixInverse.copy(se.projectionMatrixInverse);else{const Ve=rt+ve,w=b+ve,S=_e-Xe,k=le+(Oe-Xe),G=ne*b/w*Ve,F=ee*b/w*Ve;j.projectionMatrix.makePerspective(S,k,G,F,Ve,w),j.projectionMatrixInverse.copy(j.projectionMatrix).invert()}}function ge(j,se){se===null?j.matrixWorld.copy(j.matrix):j.matrixWorld.multiplyMatrices(se.matrixWorld,j.matrix),j.matrixWorldInverse.copy(j.matrixWorld).invert()}this.updateCamera=function(j){if(r===null)return;let se=j.near,Te=j.far;m.texture!==null&&(m.depthNear>0&&(se=m.depthNear),m.depthFar>0&&(Te=m.depthFar)),B.near=M.near=T.near=se,B.far=M.far=T.far=Te,(W!==B.near||te!==B.far)&&(r.updateRenderState({depthNear:B.near,depthFar:B.far}),W=B.near,te=B.far),B.layers.mask=j.layers.mask|6,T.layers.mask=B.layers.mask&3,M.layers.mask=B.layers.mask&5;const Oe=j.parent,Ae=B.cameras;ge(B,Oe);for(let Je=0;Je<Ae.length;Je++)ge(Ae[Je],Oe);Ae.length===2?Q(B,T,M):B.projectionMatrix.copy(T.projectionMatrix),Pe(j,B,Oe)};function Pe(j,se,Te){Te===null?j.matrix.copy(se.matrixWorld):(j.matrix.copy(Te.matrixWorld),j.matrix.invert(),j.matrix.multiply(se.matrixWorld)),j.matrix.decompose(j.position,j.quaternion,j.scale),j.updateMatrixWorld(!0),j.projectionMatrix.copy(se.projectionMatrix),j.projectionMatrixInverse.copy(se.projectionMatrixInverse),j.isPerspectiveCamera&&(j.fov=Ih*2*Math.atan(1/j.projectionMatrix.elements[5]),j.zoom=1)}this.getCamera=function(){return B},this.getFoveation=function(){if(!(d===null&&p===null))return l},this.setFoveation=function(j){l=j,d!==null&&(d.fixedFoveation=j),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=j)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(B)},this.getCameraTexture=function(j){return c[j]};let je=null;function Fe(j,se){if(f=se.getViewerPose(u||o),g=se,f!==null){const Te=f.views;p!==null&&(e.setRenderTargetFramebuffer(y,p.framebuffer),e.setRenderTarget(y));let Oe=!1;Te.length!==B.cameras.length&&(B.cameras.length=0,Oe=!0);for(let b=0;b<Te.length;b++){const ne=Te[b];let ee=null;if(p!==null)ee=p.getViewport(ne);else{const Z=h.getViewSubImage(d,ne);ee=Z.viewport,b===0&&(e.setRenderTargetTextures(y,Z.colorTexture,Z.depthStencilTexture),e.setRenderTarget(y))}let K=L[b];K===void 0&&(K=new Vn,K.layers.enable(b),K.viewport=new Lt,L[b]=K),K.matrix.fromArray(ne.transform.matrix),K.matrix.decompose(K.position,K.quaternion,K.scale),K.projectionMatrix.fromArray(ne.projectionMatrix),K.projectionMatrixInverse.copy(K.projectionMatrix).invert(),K.viewport.set(ee.x,ee.y,ee.width,ee.height),b===0&&(B.matrix.copy(K.matrix),B.matrix.decompose(B.position,B.quaternion,B.scale)),Oe===!0&&B.cameras.push(K)}const Ae=r.enabledFeatures;if(Ae&&Ae.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&x){h=i.getBinding();const b=h.getDepthInformation(Te[0]);b&&b.isValid&&b.texture&&m.init(b,r.renderState)}if(Ae&&Ae.includes("camera-access")&&x){e.state.unbindTexture(),h=i.getBinding();for(let b=0;b<Te.length;b++){const ne=Te[b].camera;if(ne){let ee=c[ne];ee||(ee=new i0,c[ne]=ee);const K=h.getCameraImage(ne);ee.sourceTexture=K}}}}for(let Te=0;Te<R.length;Te++){const Oe=C[Te],Ae=R[Te];Oe!==null&&Ae!==void 0&&Ae.update(Oe,se,u||o)}je&&je(j,se),se.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:se}),g=null}const $e=new m0;$e.setAnimationLoop(Fe),this.setAnimationLoop=function(j){je=j},this.dispose=function(){}}}const Cr=new xi,HA=new St;function VA(t,e){function n(m,c){m.matrixAutoUpdate===!0&&m.updateMatrix(),c.value.copy(m.matrix)}function i(m,c){c.color.getRGB(m.fogColor.value,Kv(t)),c.isFog?(m.fogNear.value=c.near,m.fogFar.value=c.far):c.isFogExp2&&(m.fogDensity.value=c.density)}function r(m,c,v,_,y){c.isMeshBasicMaterial||c.isMeshLambertMaterial?s(m,c):c.isMeshToonMaterial?(s(m,c),h(m,c)):c.isMeshPhongMaterial?(s(m,c),f(m,c)):c.isMeshStandardMaterial?(s(m,c),d(m,c),c.isMeshPhysicalMaterial&&p(m,c,y)):c.isMeshMatcapMaterial?(s(m,c),g(m,c)):c.isMeshDepthMaterial?s(m,c):c.isMeshDistanceMaterial?(s(m,c),x(m,c)):c.isMeshNormalMaterial?s(m,c):c.isLineBasicMaterial?(o(m,c),c.isLineDashedMaterial&&a(m,c)):c.isPointsMaterial?l(m,c,v,_):c.isSpriteMaterial?u(m,c):c.isShadowMaterial?(m.color.value.copy(c.color),m.opacity.value=c.opacity):c.isShaderMaterial&&(c.uniformsNeedUpdate=!1)}function s(m,c){m.opacity.value=c.opacity,c.color&&m.diffuse.value.copy(c.color),c.emissive&&m.emissive.value.copy(c.emissive).multiplyScalar(c.emissiveIntensity),c.map&&(m.map.value=c.map,n(c.map,m.mapTransform)),c.alphaMap&&(m.alphaMap.value=c.alphaMap,n(c.alphaMap,m.alphaMapTransform)),c.bumpMap&&(m.bumpMap.value=c.bumpMap,n(c.bumpMap,m.bumpMapTransform),m.bumpScale.value=c.bumpScale,c.side===yn&&(m.bumpScale.value*=-1)),c.normalMap&&(m.normalMap.value=c.normalMap,n(c.normalMap,m.normalMapTransform),m.normalScale.value.copy(c.normalScale),c.side===yn&&m.normalScale.value.negate()),c.displacementMap&&(m.displacementMap.value=c.displacementMap,n(c.displacementMap,m.displacementMapTransform),m.displacementScale.value=c.displacementScale,m.displacementBias.value=c.displacementBias),c.emissiveMap&&(m.emissiveMap.value=c.emissiveMap,n(c.emissiveMap,m.emissiveMapTransform)),c.specularMap&&(m.specularMap.value=c.specularMap,n(c.specularMap,m.specularMapTransform)),c.alphaTest>0&&(m.alphaTest.value=c.alphaTest);const v=e.get(c),_=v.envMap,y=v.envMapRotation;_&&(m.envMap.value=_,Cr.copy(y),Cr.x*=-1,Cr.y*=-1,Cr.z*=-1,_.isCubeTexture&&_.isRenderTargetTexture===!1&&(Cr.y*=-1,Cr.z*=-1),m.envMapRotation.value.setFromMatrix4(HA.makeRotationFromEuler(Cr)),m.flipEnvMap.value=_.isCubeTexture&&_.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=c.reflectivity,m.ior.value=c.ior,m.refractionRatio.value=c.refractionRatio),c.lightMap&&(m.lightMap.value=c.lightMap,m.lightMapIntensity.value=c.lightMapIntensity,n(c.lightMap,m.lightMapTransform)),c.aoMap&&(m.aoMap.value=c.aoMap,m.aoMapIntensity.value=c.aoMapIntensity,n(c.aoMap,m.aoMapTransform))}function o(m,c){m.diffuse.value.copy(c.color),m.opacity.value=c.opacity,c.map&&(m.map.value=c.map,n(c.map,m.mapTransform))}function a(m,c){m.dashSize.value=c.dashSize,m.totalSize.value=c.dashSize+c.gapSize,m.scale.value=c.scale}function l(m,c,v,_){m.diffuse.value.copy(c.color),m.opacity.value=c.opacity,m.size.value=c.size*v,m.scale.value=_*.5,c.map&&(m.map.value=c.map,n(c.map,m.uvTransform)),c.alphaMap&&(m.alphaMap.value=c.alphaMap,n(c.alphaMap,m.alphaMapTransform)),c.alphaTest>0&&(m.alphaTest.value=c.alphaTest)}function u(m,c){m.diffuse.value.copy(c.color),m.opacity.value=c.opacity,m.rotation.value=c.rotation,c.map&&(m.map.value=c.map,n(c.map,m.mapTransform)),c.alphaMap&&(m.alphaMap.value=c.alphaMap,n(c.alphaMap,m.alphaMapTransform)),c.alphaTest>0&&(m.alphaTest.value=c.alphaTest)}function f(m,c){m.specular.value.copy(c.specular),m.shininess.value=Math.max(c.shininess,1e-4)}function h(m,c){c.gradientMap&&(m.gradientMap.value=c.gradientMap)}function d(m,c){m.metalness.value=c.metalness,c.metalnessMap&&(m.metalnessMap.value=c.metalnessMap,n(c.metalnessMap,m.metalnessMapTransform)),m.roughness.value=c.roughness,c.roughnessMap&&(m.roughnessMap.value=c.roughnessMap,n(c.roughnessMap,m.roughnessMapTransform)),c.envMap&&(m.envMapIntensity.value=c.envMapIntensity)}function p(m,c,v){m.ior.value=c.ior,c.sheen>0&&(m.sheenColor.value.copy(c.sheenColor).multiplyScalar(c.sheen),m.sheenRoughness.value=c.sheenRoughness,c.sheenColorMap&&(m.sheenColorMap.value=c.sheenColorMap,n(c.sheenColorMap,m.sheenColorMapTransform)),c.sheenRoughnessMap&&(m.sheenRoughnessMap.value=c.sheenRoughnessMap,n(c.sheenRoughnessMap,m.sheenRoughnessMapTransform))),c.clearcoat>0&&(m.clearcoat.value=c.clearcoat,m.clearcoatRoughness.value=c.clearcoatRoughness,c.clearcoatMap&&(m.clearcoatMap.value=c.clearcoatMap,n(c.clearcoatMap,m.clearcoatMapTransform)),c.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=c.clearcoatRoughnessMap,n(c.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),c.clearcoatNormalMap&&(m.clearcoatNormalMap.value=c.clearcoatNormalMap,n(c.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(c.clearcoatNormalScale),c.side===yn&&m.clearcoatNormalScale.value.negate())),c.dispersion>0&&(m.dispersion.value=c.dispersion),c.iridescence>0&&(m.iridescence.value=c.iridescence,m.iridescenceIOR.value=c.iridescenceIOR,m.iridescenceThicknessMinimum.value=c.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=c.iridescenceThicknessRange[1],c.iridescenceMap&&(m.iridescenceMap.value=c.iridescenceMap,n(c.iridescenceMap,m.iridescenceMapTransform)),c.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=c.iridescenceThicknessMap,n(c.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),c.transmission>0&&(m.transmission.value=c.transmission,m.transmissionSamplerMap.value=v.texture,m.transmissionSamplerSize.value.set(v.width,v.height),c.transmissionMap&&(m.transmissionMap.value=c.transmissionMap,n(c.transmissionMap,m.transmissionMapTransform)),m.thickness.value=c.thickness,c.thicknessMap&&(m.thicknessMap.value=c.thicknessMap,n(c.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=c.attenuationDistance,m.attenuationColor.value.copy(c.attenuationColor)),c.anisotropy>0&&(m.anisotropyVector.value.set(c.anisotropy*Math.cos(c.anisotropyRotation),c.anisotropy*Math.sin(c.anisotropyRotation)),c.anisotropyMap&&(m.anisotropyMap.value=c.anisotropyMap,n(c.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=c.specularIntensity,m.specularColor.value.copy(c.specularColor),c.specularColorMap&&(m.specularColorMap.value=c.specularColorMap,n(c.specularColorMap,m.specularColorMapTransform)),c.specularIntensityMap&&(m.specularIntensityMap.value=c.specularIntensityMap,n(c.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,c){c.matcap&&(m.matcap.value=c.matcap)}function x(m,c){const v=e.get(c).light;m.referencePosition.value.setFromMatrixPosition(v.matrixWorld),m.nearDistance.value=v.shadow.camera.near,m.farDistance.value=v.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function GA(t,e,n,i){let r={},s={},o=[];const a=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(v,_){const y=_.program;i.uniformBlockBinding(v,y)}function u(v,_){let y=r[v.id];y===void 0&&(g(v),y=f(v),r[v.id]=y,v.addEventListener("dispose",m));const R=_.program;i.updateUBOMapping(v,R);const C=e.render.frame;s[v.id]!==C&&(d(v),s[v.id]=C)}function f(v){const _=h();v.__bindingPointIndex=_;const y=t.createBuffer(),R=v.__size,C=v.usage;return t.bindBuffer(t.UNIFORM_BUFFER,y),t.bufferData(t.UNIFORM_BUFFER,R,C),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,_,y),y}function h(){for(let v=0;v<a;v++)if(o.indexOf(v)===-1)return o.push(v),v;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(v){const _=r[v.id],y=v.uniforms,R=v.__cache;t.bindBuffer(t.UNIFORM_BUFFER,_);for(let C=0,A=y.length;C<A;C++){const P=Array.isArray(y[C])?y[C]:[y[C]];for(let T=0,M=P.length;T<M;T++){const L=P[T];if(p(L,C,T,R)===!0){const B=L.__offset,W=Array.isArray(L.value)?L.value:[L.value];let te=0;for(let X=0;X<W.length;X++){const Y=W[X],J=x(Y);typeof Y=="number"||typeof Y=="boolean"?(L.__data[0]=Y,t.bufferSubData(t.UNIFORM_BUFFER,B+te,L.__data)):Y.isMatrix3?(L.__data[0]=Y.elements[0],L.__data[1]=Y.elements[1],L.__data[2]=Y.elements[2],L.__data[3]=0,L.__data[4]=Y.elements[3],L.__data[5]=Y.elements[4],L.__data[6]=Y.elements[5],L.__data[7]=0,L.__data[8]=Y.elements[6],L.__data[9]=Y.elements[7],L.__data[10]=Y.elements[8],L.__data[11]=0):(Y.toArray(L.__data,te),te+=J.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,B,L.__data)}}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function p(v,_,y,R){const C=v.value,A=_+"_"+y;if(R[A]===void 0)return typeof C=="number"||typeof C=="boolean"?R[A]=C:R[A]=C.clone(),!0;{const P=R[A];if(typeof C=="number"||typeof C=="boolean"){if(P!==C)return R[A]=C,!0}else if(P.equals(C)===!1)return P.copy(C),!0}return!1}function g(v){const _=v.uniforms;let y=0;const R=16;for(let A=0,P=_.length;A<P;A++){const T=Array.isArray(_[A])?_[A]:[_[A]];for(let M=0,L=T.length;M<L;M++){const B=T[M],W=Array.isArray(B.value)?B.value:[B.value];for(let te=0,X=W.length;te<X;te++){const Y=W[te],J=x(Y),N=y%R,q=N%J.boundary,Q=N+q;y+=q,Q!==0&&R-Q<J.storage&&(y+=R-Q),B.__data=new Float32Array(J.storage/Float32Array.BYTES_PER_ELEMENT),B.__offset=y,y+=J.storage}}}const C=y%R;return C>0&&(y+=R-C),v.__size=y,v.__cache={},this}function x(v){const _={boundary:0,storage:0};return typeof v=="number"||typeof v=="boolean"?(_.boundary=4,_.storage=4):v.isVector2?(_.boundary=8,_.storage=8):v.isVector3||v.isColor?(_.boundary=16,_.storage=12):v.isVector4?(_.boundary=16,_.storage=16):v.isMatrix3?(_.boundary=48,_.storage=48):v.isMatrix4?(_.boundary=64,_.storage=64):v.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",v),_}function m(v){const _=v.target;_.removeEventListener("dispose",m);const y=o.indexOf(_.__bindingPointIndex);o.splice(y,1),t.deleteBuffer(r[_.id]),delete r[_.id],delete s[_.id]}function c(){for(const v in r)t.deleteBuffer(r[v]);o=[],r={},s={}}return{bind:l,update:u,dispose:c}}class WA{constructor(e={}){const{canvas:n=zS(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:u=!1,powerPreference:f="default",failIfMajorPerformanceCaveat:h=!1,reversedDepthBuffer:d=!1}=e;this.isWebGLRenderer=!0;let p;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=i.getContextAttributes().alpha}else p=o;const g=new Uint32Array(4),x=new Int32Array(4);let m=null,c=null;const v=[],_=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=fr,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const y=this;let R=!1;this._outputColorSpace=zn;let C=0,A=0,P=null,T=-1,M=null;const L=new Lt,B=new Lt;let W=null;const te=new it(0);let X=0,Y=n.width,J=n.height,N=1,q=null,Q=null;const ge=new Lt(0,0,Y,J),Pe=new Lt(0,0,Y,J);let je=!1;const Fe=new Gd;let $e=!1,j=!1;const se=new St,Te=new I,Oe=new Lt,Ae={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Je=!1;function rt(){return P===null?N:1}let b=i;function ne(E,O){return n.getContext(E,O)}try{const E={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:u,powerPreference:f,failIfMajorPerformanceCaveat:h};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${Ud}`),n.addEventListener("webglcontextlost",me,!1),n.addEventListener("webglcontextrestored",ye,!1),n.addEventListener("webglcontextcreationerror",re,!1),b===null){const O="webgl2";if(b=ne(O,E),b===null)throw ne(O)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(E){throw console.error("THREE.WebGLRenderer: "+E.message),E}let ee,K,Z,_e,le,ve,Xe,Ve,w,S,k,G,F,U,he,oe,Ee,xe,ie,de,Le,Ce,pe,De;function D(){ee=new ew(b),ee.init(),Ce=new FA(b,ee),K=new j1(b,ee,e,Ce),Z=new IA(b,ee),K.reversedDepthBuffer&&d&&Z.buffers.depth.setReversed(!0),_e=new iw(b),le=new SA,ve=new UA(b,ee,Z,le,K,Ce,_e),Xe=new $1(y),Ve=new Q1(y),w=new uE(b),pe=new X1(b,w),S=new tw(b,w,_e,pe),k=new sw(b,S,w,_e),ie=new rw(b,K,ve),oe=new q1(le),G=new yA(y,Xe,Ve,ee,K,pe,oe),F=new VA(y,le),U=new EA,he=new bA(ee),xe=new W1(y,Xe,Ve,Z,k,p,l),Ee=new DA(y,k,K),De=new GA(b,_e,K,Z),de=new Y1(b,ee,_e),Le=new nw(b,ee,_e),_e.programs=G.programs,y.capabilities=K,y.extensions=ee,y.properties=le,y.renderLists=U,y.shadowMap=Ee,y.state=Z,y.info=_e}D();const ae=new BA(y,b);this.xr=ae,this.getContext=function(){return b},this.getContextAttributes=function(){return b.getContextAttributes()},this.forceContextLoss=function(){const E=ee.get("WEBGL_lose_context");E&&E.loseContext()},this.forceContextRestore=function(){const E=ee.get("WEBGL_lose_context");E&&E.restoreContext()},this.getPixelRatio=function(){return N},this.setPixelRatio=function(E){E!==void 0&&(N=E,this.setSize(Y,J,!1))},this.getSize=function(E){return E.set(Y,J)},this.setSize=function(E,O,H=!0){if(ae.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}Y=E,J=O,n.width=Math.floor(E*N),n.height=Math.floor(O*N),H===!0&&(n.style.width=E+"px",n.style.height=O+"px"),this.setViewport(0,0,E,O)},this.getDrawingBufferSize=function(E){return E.set(Y*N,J*N).floor()},this.setDrawingBufferSize=function(E,O,H){Y=E,J=O,N=H,n.width=Math.floor(E*H),n.height=Math.floor(O*H),this.setViewport(0,0,E,O)},this.getCurrentViewport=function(E){return E.copy(L)},this.getViewport=function(E){return E.copy(ge)},this.setViewport=function(E,O,H,V){E.isVector4?ge.set(E.x,E.y,E.z,E.w):ge.set(E,O,H,V),Z.viewport(L.copy(ge).multiplyScalar(N).round())},this.getScissor=function(E){return E.copy(Pe)},this.setScissor=function(E,O,H,V){E.isVector4?Pe.set(E.x,E.y,E.z,E.w):Pe.set(E,O,H,V),Z.scissor(B.copy(Pe).multiplyScalar(N).round())},this.getScissorTest=function(){return je},this.setScissorTest=function(E){Z.setScissorTest(je=E)},this.setOpaqueSort=function(E){q=E},this.setTransparentSort=function(E){Q=E},this.getClearColor=function(E){return E.copy(xe.getClearColor())},this.setClearColor=function(){xe.setClearColor(...arguments)},this.getClearAlpha=function(){return xe.getClearAlpha()},this.setClearAlpha=function(){xe.setClearAlpha(...arguments)},this.clear=function(E=!0,O=!0,H=!0){let V=0;if(E){let z=!1;if(P!==null){const ce=P.texture.format;z=ce===Hd||ce===Bd||ce===zd}if(z){const ce=P.texture.type,Me=ce===vi||ce===Yr||ce===ua||ce===ca||ce===Od||ce===kd,Ie=xe.getClearColor(),be=xe.getClearAlpha(),Ge=Ie.r,We=Ie.g,Be=Ie.b;Me?(g[0]=Ge,g[1]=We,g[2]=Be,g[3]=be,b.clearBufferuiv(b.COLOR,0,g)):(x[0]=Ge,x[1]=We,x[2]=Be,x[3]=be,b.clearBufferiv(b.COLOR,0,x))}else V|=b.COLOR_BUFFER_BIT}O&&(V|=b.DEPTH_BUFFER_BIT),H&&(V|=b.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),b.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",me,!1),n.removeEventListener("webglcontextrestored",ye,!1),n.removeEventListener("webglcontextcreationerror",re,!1),xe.dispose(),U.dispose(),he.dispose(),le.dispose(),Xe.dispose(),Ve.dispose(),k.dispose(),pe.dispose(),De.dispose(),G.dispose(),ae.dispose(),ae.removeEventListener("sessionstart",ke),ae.removeEventListener("sessionend",ot),qt.stop()};function me(E){E.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),R=!0}function ye(){console.log("THREE.WebGLRenderer: Context Restored."),R=!1;const E=_e.autoReset,O=Ee.enabled,H=Ee.autoUpdate,V=Ee.needsUpdate,z=Ee.type;D(),_e.autoReset=E,Ee.enabled=O,Ee.autoUpdate=H,Ee.needsUpdate=V,Ee.type=z}function re(E){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",E.statusMessage)}function $(E){const O=E.target;O.removeEventListener("dispose",$),we(O)}function we(E){ze(E),le.remove(E)}function ze(E){const O=le.get(E).programs;O!==void 0&&(O.forEach(function(H){G.releaseProgram(H)}),E.isShaderMaterial&&G.releaseShaderCache(E))}this.renderBufferDirect=function(E,O,H,V,z,ce){O===null&&(O=Ae);const Me=z.isMesh&&z.matrixWorld.determinant()<0,Ie=lo(E,O,H,V,z);Z.setMaterial(V,Me);let be=H.index,Ge=1;if(V.wireframe===!0){if(be=S.getWireframeAttribute(H),be===void 0)return;Ge=2}const We=H.drawRange,Be=H.attributes.position;let nt=We.start*Ge,ct=(We.start+We.count)*Ge;ce!==null&&(nt=Math.max(nt,ce.start*Ge),ct=Math.min(ct,(ce.start+ce.count)*Ge)),be!==null?(nt=Math.max(nt,0),ct=Math.min(ct,be.count)):Be!=null&&(nt=Math.max(nt,0),ct=Math.min(ct,Be.count));const bt=ct-nt;if(bt<0||bt===1/0)return;pe.setup(z,V,Ie,H,be);let vt,mt=de;if(be!==null&&(vt=w.get(be),mt=Le,mt.setIndex(vt)),z.isMesh)V.wireframe===!0?(Z.setLineWidth(V.wireframeLinewidth*rt()),mt.setMode(b.LINES)):mt.setMode(b.TRIANGLES);else if(z.isLine){let He=V.linewidth;He===void 0&&(He=1),Z.setLineWidth(He*rt()),z.isLineSegments?mt.setMode(b.LINES):z.isLineLoop?mt.setMode(b.LINE_LOOP):mt.setMode(b.LINE_STRIP)}else z.isPoints?mt.setMode(b.POINTS):z.isSprite&&mt.setMode(b.TRIANGLES);if(z.isBatchedMesh)if(z._multiDrawInstances!==null)da("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),mt.renderMultiDrawInstances(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount,z._multiDrawInstances);else if(ee.get("WEBGL_multi_draw"))mt.renderMultiDraw(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount);else{const He=z._multiDrawStarts,Et=z._multiDrawCounts,at=z._multiDrawCount,Mn=be?w.get(be).bytesPerElement:1,ts=le.get(V).currentProgram.getUniforms();for(let En=0;En<at;En++)ts.setValue(b,"_gl_DrawID",En),mt.render(He[En]/Mn,Et[En])}else if(z.isInstancedMesh)mt.renderInstances(nt,bt,z.count);else if(H.isInstancedBufferGeometry){const He=H._maxInstanceCount!==void 0?H._maxInstanceCount:1/0,Et=Math.min(H.instanceCount,He);mt.renderInstances(nt,bt,Et)}else mt.render(nt,bt)};function tt(E,O,H){E.transparent===!0&&E.side===bi&&E.forceSinglePass===!1?(E.side=yn,E.needsUpdate=!0,qn(E,O,H),E.side=pr,E.needsUpdate=!0,qn(E,O,H),E.side=bi):qn(E,O,H)}this.compile=function(E,O,H=null){H===null&&(H=E),c=he.get(H),c.init(O),_.push(c),H.traverseVisible(function(z){z.isLight&&z.layers.test(O.layers)&&(c.pushLight(z),z.castShadow&&c.pushShadow(z))}),E!==H&&E.traverseVisible(function(z){z.isLight&&z.layers.test(O.layers)&&(c.pushLight(z),z.castShadow&&c.pushShadow(z))}),c.setupLights();const V=new Set;return E.traverse(function(z){if(!(z.isMesh||z.isPoints||z.isLine||z.isSprite))return;const ce=z.material;if(ce)if(Array.isArray(ce))for(let Me=0;Me<ce.length;Me++){const Ie=ce[Me];tt(Ie,H,z),V.add(Ie)}else tt(ce,H,z),V.add(ce)}),c=_.pop(),V},this.compileAsync=function(E,O,H=null){const V=this.compile(E,O,H);return new Promise(z=>{function ce(){if(V.forEach(function(Me){le.get(Me).currentProgram.isReady()&&V.delete(Me)}),V.size===0){z(E);return}setTimeout(ce,10)}ee.get("KHR_parallel_shader_compile")!==null?ce():setTimeout(ce,10)})};let Qe=null;function Ye(E){Qe&&Qe(E)}function ke(){qt.stop()}function ot(){qt.start()}const qt=new m0;qt.setAnimationLoop(Ye),typeof self<"u"&&qt.setContext(self),this.setAnimationLoop=function(E){Qe=E,ae.setAnimationLoop(E),E===null?qt.stop():qt.start()},ae.addEventListener("sessionstart",ke),ae.addEventListener("sessionend",ot),this.render=function(E,O){if(O!==void 0&&O.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(R===!0)return;if(E.matrixWorldAutoUpdate===!0&&E.updateMatrixWorld(),O.parent===null&&O.matrixWorldAutoUpdate===!0&&O.updateMatrixWorld(),ae.enabled===!0&&ae.isPresenting===!0&&(ae.cameraAutoUpdate===!0&&ae.updateCamera(O),O=ae.getCamera()),E.isScene===!0&&E.onBeforeRender(y,E,O,P),c=he.get(E,_.length),c.init(O),_.push(c),se.multiplyMatrices(O.projectionMatrix,O.matrixWorldInverse),Fe.setFromProjectionMatrix(se,pi,O.reversedDepth),j=this.localClippingEnabled,$e=oe.init(this.clippingPlanes,j),m=U.get(E,v.length),m.init(),v.push(m),ae.enabled===!0&&ae.isPresenting===!0){const ce=y.xr.getDepthSensingMesh();ce!==null&&tn(ce,O,-1/0,y.sortObjects)}tn(E,O,0,y.sortObjects),m.finish(),y.sortObjects===!0&&m.sort(q,Q),Je=ae.enabled===!1||ae.isPresenting===!1||ae.hasDepthSensing()===!1,Je&&xe.addToRenderList(m,E),this.info.render.frame++,$e===!0&&oe.beginShadows();const H=c.state.shadowsArray;Ee.render(H,E,O),$e===!0&&oe.endShadows(),this.info.autoReset===!0&&this.info.reset();const V=m.opaque,z=m.transmissive;if(c.setupLights(),O.isArrayCamera){const ce=O.cameras;if(z.length>0)for(let Me=0,Ie=ce.length;Me<Ie;Me++){const be=ce[Me];pt(V,z,E,be)}Je&&xe.render(E);for(let Me=0,Ie=ce.length;Me<Ie;Me++){const be=ce[Me];Un(m,E,be,be.viewport)}}else z.length>0&&pt(V,z,E,O),Je&&xe.render(E),Un(m,E,O);P!==null&&A===0&&(ve.updateMultisampleRenderTarget(P),ve.updateRenderTargetMipmap(P)),E.isScene===!0&&E.onAfterRender(y,E,O),pe.resetDefaultState(),T=-1,M=null,_.pop(),_.length>0?(c=_[_.length-1],$e===!0&&oe.setGlobalState(y.clippingPlanes,c.state.camera)):c=null,v.pop(),v.length>0?m=v[v.length-1]:m=null};function tn(E,O,H,V){if(E.visible===!1)return;if(E.layers.test(O.layers)){if(E.isGroup)H=E.renderOrder;else if(E.isLOD)E.autoUpdate===!0&&E.update(O);else if(E.isLight)c.pushLight(E),E.castShadow&&c.pushShadow(E);else if(E.isSprite){if(!E.frustumCulled||Fe.intersectsSprite(E)){V&&Oe.setFromMatrixPosition(E.matrixWorld).applyMatrix4(se);const Me=k.update(E),Ie=E.material;Ie.visible&&m.push(E,Me,Ie,H,Oe.z,null)}}else if((E.isMesh||E.isLine||E.isPoints)&&(!E.frustumCulled||Fe.intersectsObject(E))){const Me=k.update(E),Ie=E.material;if(V&&(E.boundingSphere!==void 0?(E.boundingSphere===null&&E.computeBoundingSphere(),Oe.copy(E.boundingSphere.center)):(Me.boundingSphere===null&&Me.computeBoundingSphere(),Oe.copy(Me.boundingSphere.center)),Oe.applyMatrix4(E.matrixWorld).applyMatrix4(se)),Array.isArray(Ie)){const be=Me.groups;for(let Ge=0,We=be.length;Ge<We;Ge++){const Be=be[Ge],nt=Ie[Be.materialIndex];nt&&nt.visible&&m.push(E,Me,nt,H,Oe.z,Be)}}else Ie.visible&&m.push(E,Me,Ie,H,Oe.z,null)}}const ce=E.children;for(let Me=0,Ie=ce.length;Me<Ie;Me++)tn(ce[Me],O,H,V)}function Un(E,O,H,V){const z=E.opaque,ce=E.transmissive,Me=E.transparent;c.setupLightsView(H),$e===!0&&oe.setGlobalState(y.clippingPlanes,H),V&&Z.viewport(L.copy(V)),z.length>0&&_t(z,O,H),ce.length>0&&_t(ce,O,H),Me.length>0&&_t(Me,O,H),Z.buffers.depth.setTest(!0),Z.buffers.depth.setMask(!0),Z.buffers.color.setMask(!0),Z.setPolygonOffset(!1)}function pt(E,O,H,V){if((H.isScene===!0?H.overrideMaterial:null)!==null)return;c.state.transmissionRenderTarget[V.id]===void 0&&(c.state.transmissionRenderTarget[V.id]=new qr(1,1,{generateMipmaps:!0,type:ee.has("EXT_color_buffer_half_float")||ee.has("EXT_color_buffer_float")?Ma:vi,minFilter:kr,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:lt.workingColorSpace}));const ce=c.state.transmissionRenderTarget[V.id],Me=V.viewport||L;ce.setSize(Me.z*y.transmissionResolutionScale,Me.w*y.transmissionResolutionScale);const Ie=y.getRenderTarget(),be=y.getActiveCubeFace(),Ge=y.getActiveMipmapLevel();y.setRenderTarget(ce),y.getClearColor(te),X=y.getClearAlpha(),X<1&&y.setClearColor(16777215,.5),y.clear(),Je&&xe.render(H);const We=y.toneMapping;y.toneMapping=fr;const Be=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),c.setupLightsView(V),$e===!0&&oe.setGlobalState(y.clippingPlanes,V),_t(E,H,V),ve.updateMultisampleRenderTarget(ce),ve.updateRenderTargetMipmap(ce),ee.has("WEBGL_multisampled_render_to_texture")===!1){let nt=!1;for(let ct=0,bt=O.length;ct<bt;ct++){const vt=O[ct],mt=vt.object,He=vt.geometry,Et=vt.material,at=vt.group;if(Et.side===bi&&mt.layers.test(V.layers)){const Mn=Et.side;Et.side=yn,Et.needsUpdate=!0,Wt(mt,H,V,He,Et,at),Et.side=Mn,Et.needsUpdate=!0,nt=!0}}nt===!0&&(ve.updateMultisampleRenderTarget(ce),ve.updateRenderTargetMipmap(ce))}y.setRenderTarget(Ie,be,Ge),y.setClearColor(te,X),Be!==void 0&&(V.viewport=Be),y.toneMapping=We}function _t(E,O,H){const V=O.isScene===!0?O.overrideMaterial:null;for(let z=0,ce=E.length;z<ce;z++){const Me=E[z],Ie=Me.object,be=Me.geometry,Ge=Me.group;let We=Me.material;We.allowOverride===!0&&V!==null&&(We=V),Ie.layers.test(H.layers)&&Wt(Ie,O,H,be,We,Ge)}}function Wt(E,O,H,V,z,ce){E.onBeforeRender(y,O,H,V,z,ce),E.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse,E.matrixWorld),E.normalMatrix.getNormalMatrix(E.modelViewMatrix),z.onBeforeRender(y,O,H,V,E,ce),z.transparent===!0&&z.side===bi&&z.forceSinglePass===!1?(z.side=yn,z.needsUpdate=!0,y.renderBufferDirect(H,O,V,z,E,ce),z.side=pr,z.needsUpdate=!0,y.renderBufferDirect(H,O,V,z,E,ce),z.side=bi):y.renderBufferDirect(H,O,V,z,E,ce),E.onAfterRender(y,O,H,V,z,ce)}function qn(E,O,H){O.isScene!==!0&&(O=Ae);const V=le.get(E),z=c.state.lights,ce=c.state.shadowsArray,Me=z.state.version,Ie=G.getParameters(E,z.state,ce,O,H),be=G.getProgramCacheKey(Ie);let Ge=V.programs;V.environment=E.isMeshStandardMaterial?O.environment:null,V.fog=O.fog,V.envMap=(E.isMeshStandardMaterial?Ve:Xe).get(E.envMap||V.environment),V.envMapRotation=V.environment!==null&&E.envMap===null?O.environmentRotation:E.envMapRotation,Ge===void 0&&(E.addEventListener("dispose",$),Ge=new Map,V.programs=Ge);let We=Ge.get(be);if(We!==void 0){if(V.currentProgram===We&&V.lightsStateVersion===Me)return yr(E,Ie),We}else Ie.uniforms=G.getUniforms(E),E.onBeforeCompile(Ie,y),We=G.acquireProgram(Ie,be),Ge.set(be,We),V.uniforms=Ie.uniforms;const Be=V.uniforms;return(!E.isShaderMaterial&&!E.isRawShaderMaterial||E.clipping===!0)&&(Be.clippingPlanes=oe.uniform),yr(E,Ie),V.needsLights=uo(E),V.lightsStateVersion=Me,V.needsLights&&(Be.ambientLightColor.value=z.state.ambient,Be.lightProbe.value=z.state.probe,Be.directionalLights.value=z.state.directional,Be.directionalLightShadows.value=z.state.directionalShadow,Be.spotLights.value=z.state.spot,Be.spotLightShadows.value=z.state.spotShadow,Be.rectAreaLights.value=z.state.rectArea,Be.ltc_1.value=z.state.rectAreaLTC1,Be.ltc_2.value=z.state.rectAreaLTC2,Be.pointLights.value=z.state.point,Be.pointLightShadows.value=z.state.pointShadow,Be.hemisphereLights.value=z.state.hemi,Be.directionalShadowMap.value=z.state.directionalShadowMap,Be.directionalShadowMatrix.value=z.state.directionalShadowMatrix,Be.spotShadowMap.value=z.state.spotShadowMap,Be.spotLightMatrix.value=z.state.spotLightMatrix,Be.spotLightMap.value=z.state.spotLightMap,Be.pointShadowMap.value=z.state.pointShadowMap,Be.pointShadowMatrix.value=z.state.pointShadowMatrix),V.currentProgram=We,V.uniformsList=null,We}function $n(E){if(E.uniformsList===null){const O=E.currentProgram.getUniforms();E.uniformsList=Gl.seqWithValue(O.seq,E.uniforms)}return E.uniformsList}function yr(E,O){const H=le.get(E);H.outputColorSpace=O.outputColorSpace,H.batching=O.batching,H.batchingColor=O.batchingColor,H.instancing=O.instancing,H.instancingColor=O.instancingColor,H.instancingMorph=O.instancingMorph,H.skinning=O.skinning,H.morphTargets=O.morphTargets,H.morphNormals=O.morphNormals,H.morphColors=O.morphColors,H.morphTargetsCount=O.morphTargetsCount,H.numClippingPlanes=O.numClippingPlanes,H.numIntersection=O.numClipIntersection,H.vertexAlphas=O.vertexAlphas,H.vertexTangents=O.vertexTangents,H.toneMapping=O.toneMapping}function lo(E,O,H,V,z){O.isScene!==!0&&(O=Ae),ve.resetTextureUnits();const ce=O.fog,Me=V.isMeshStandardMaterial?O.environment:null,Ie=P===null?y.outputColorSpace:P.isXRRenderTarget===!0?P.texture.colorSpace:to,be=(V.isMeshStandardMaterial?Ve:Xe).get(V.envMap||Me),Ge=V.vertexColors===!0&&!!H.attributes.color&&H.attributes.color.itemSize===4,We=!!H.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),Be=!!H.morphAttributes.position,nt=!!H.morphAttributes.normal,ct=!!H.morphAttributes.color;let bt=fr;V.toneMapped&&(P===null||P.isXRRenderTarget===!0)&&(bt=y.toneMapping);const vt=H.morphAttributes.position||H.morphAttributes.normal||H.morphAttributes.color,mt=vt!==void 0?vt.length:0,He=le.get(V),Et=c.state.lights;if($e===!0&&(j===!0||E!==M)){const nn=E===M&&V.id===T;oe.setState(V,E,nn)}let at=!1;V.version===He.__version?(He.needsLights&&He.lightsStateVersion!==Et.state.version||He.outputColorSpace!==Ie||z.isBatchedMesh&&He.batching===!1||!z.isBatchedMesh&&He.batching===!0||z.isBatchedMesh&&He.batchingColor===!0&&z.colorTexture===null||z.isBatchedMesh&&He.batchingColor===!1&&z.colorTexture!==null||z.isInstancedMesh&&He.instancing===!1||!z.isInstancedMesh&&He.instancing===!0||z.isSkinnedMesh&&He.skinning===!1||!z.isSkinnedMesh&&He.skinning===!0||z.isInstancedMesh&&He.instancingColor===!0&&z.instanceColor===null||z.isInstancedMesh&&He.instancingColor===!1&&z.instanceColor!==null||z.isInstancedMesh&&He.instancingMorph===!0&&z.morphTexture===null||z.isInstancedMesh&&He.instancingMorph===!1&&z.morphTexture!==null||He.envMap!==be||V.fog===!0&&He.fog!==ce||He.numClippingPlanes!==void 0&&(He.numClippingPlanes!==oe.numPlanes||He.numIntersection!==oe.numIntersection)||He.vertexAlphas!==Ge||He.vertexTangents!==We||He.morphTargets!==Be||He.morphNormals!==nt||He.morphColors!==ct||He.toneMapping!==bt||He.morphTargetsCount!==mt)&&(at=!0):(at=!0,He.__version=V.version);let Mn=He.currentProgram;at===!0&&(Mn=qn(V,O,z));let ts=!1,En=!1,co=!1;const Tt=Mn.getUniforms(),Fn=He.uniforms;if(Z.useProgram(Mn.program)&&(ts=!0,En=!0,co=!0),V.id!==T&&(T=V.id,En=!0),ts||M!==E){Z.buffers.depth.getReversed()&&E.reversedDepth!==!0&&(E._reversedDepth=!0,E.updateProjectionMatrix()),Tt.setValue(b,"projectionMatrix",E.projectionMatrix),Tt.setValue(b,"viewMatrix",E.matrixWorldInverse);const dn=Tt.map.cameraPosition;dn!==void 0&&dn.setValue(b,Te.setFromMatrixPosition(E.matrixWorld)),K.logarithmicDepthBuffer&&Tt.setValue(b,"logDepthBufFC",2/(Math.log(E.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&Tt.setValue(b,"isOrthographic",E.isOrthographicCamera===!0),M!==E&&(M=E,En=!0,co=!0)}if(z.isSkinnedMesh){Tt.setOptional(b,z,"bindMatrix"),Tt.setOptional(b,z,"bindMatrixInverse");const nn=z.skeleton;nn&&(nn.boneTexture===null&&nn.computeBoneTexture(),Tt.setValue(b,"boneTexture",nn.boneTexture,ve))}z.isBatchedMesh&&(Tt.setOptional(b,z,"batchingTexture"),Tt.setValue(b,"batchingTexture",z._matricesTexture,ve),Tt.setOptional(b,z,"batchingIdTexture"),Tt.setValue(b,"batchingIdTexture",z._indirectTexture,ve),Tt.setOptional(b,z,"batchingColorTexture"),z._colorsTexture!==null&&Tt.setValue(b,"batchingColorTexture",z._colorsTexture,ve));const On=H.morphAttributes;if((On.position!==void 0||On.normal!==void 0||On.color!==void 0)&&ie.update(z,H,Mn),(En||He.receiveShadow!==z.receiveShadow)&&(He.receiveShadow=z.receiveShadow,Tt.setValue(b,"receiveShadow",z.receiveShadow)),V.isMeshGouraudMaterial&&V.envMap!==null&&(Fn.envMap.value=be,Fn.flipEnvMap.value=be.isCubeTexture&&be.isRenderTargetTexture===!1?-1:1),V.isMeshStandardMaterial&&V.envMap===null&&O.environment!==null&&(Fn.envMapIntensity.value=O.environmentIntensity),En&&(Tt.setValue(b,"toneMappingExposure",y.toneMappingExposure),He.needsLights&&hn(Fn,co),ce&&V.fog===!0&&F.refreshFogUniforms(Fn,ce),F.refreshMaterialUniforms(Fn,V,N,J,c.state.transmissionRenderTarget[E.id]),Gl.upload(b,$n(He),Fn,ve)),V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(Gl.upload(b,$n(He),Fn,ve),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&Tt.setValue(b,"center",z.center),Tt.setValue(b,"modelViewMatrix",z.modelViewMatrix),Tt.setValue(b,"normalMatrix",z.normalMatrix),Tt.setValue(b,"modelMatrix",z.matrixWorld),V.isShaderMaterial||V.isRawShaderMaterial){const nn=V.uniformsGroups;for(let dn=0,Bu=nn.length;dn<Bu;dn++){const Mr=nn[dn];De.update(Mr,Mn),De.bind(Mr,Mn)}}return Mn}function hn(E,O){E.ambientLightColor.needsUpdate=O,E.lightProbe.needsUpdate=O,E.directionalLights.needsUpdate=O,E.directionalLightShadows.needsUpdate=O,E.pointLights.needsUpdate=O,E.pointLightShadows.needsUpdate=O,E.spotLights.needsUpdate=O,E.spotLightShadows.needsUpdate=O,E.rectAreaLights.needsUpdate=O,E.hemisphereLights.needsUpdate=O}function uo(E){return E.isMeshLambertMaterial||E.isMeshToonMaterial||E.isMeshPhongMaterial||E.isMeshStandardMaterial||E.isShadowMaterial||E.isShaderMaterial&&E.lights===!0}this.getActiveCubeFace=function(){return C},this.getActiveMipmapLevel=function(){return A},this.getRenderTarget=function(){return P},this.setRenderTargetTextures=function(E,O,H){const V=le.get(E);V.__autoAllocateDepthBuffer=E.resolveDepthBuffer===!1,V.__autoAllocateDepthBuffer===!1&&(V.__useRenderToTexture=!1),le.get(E.texture).__webglTexture=O,le.get(E.depthTexture).__webglTexture=V.__autoAllocateDepthBuffer?void 0:H,V.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(E,O){const H=le.get(E);H.__webglFramebuffer=O,H.__useDefaultFramebuffer=O===void 0};const Sr=b.createFramebuffer();this.setRenderTarget=function(E,O=0,H=0){P=E,C=O,A=H;let V=!0,z=null,ce=!1,Me=!1;if(E){const be=le.get(E);if(be.__useDefaultFramebuffer!==void 0)Z.bindFramebuffer(b.FRAMEBUFFER,null),V=!1;else if(be.__webglFramebuffer===void 0)ve.setupRenderTarget(E);else if(be.__hasExternalTextures)ve.rebindTextures(E,le.get(E.texture).__webglTexture,le.get(E.depthTexture).__webglTexture);else if(E.depthBuffer){const Be=E.depthTexture;if(be.__boundDepthTexture!==Be){if(Be!==null&&le.has(Be)&&(E.width!==Be.image.width||E.height!==Be.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");ve.setupDepthRenderbuffer(E)}}const Ge=E.texture;(Ge.isData3DTexture||Ge.isDataArrayTexture||Ge.isCompressedArrayTexture)&&(Me=!0);const We=le.get(E).__webglFramebuffer;E.isWebGLCubeRenderTarget?(Array.isArray(We[O])?z=We[O][H]:z=We[O],ce=!0):E.samples>0&&ve.useMultisampledRTT(E)===!1?z=le.get(E).__webglMultisampledFramebuffer:Array.isArray(We)?z=We[H]:z=We,L.copy(E.viewport),B.copy(E.scissor),W=E.scissorTest}else L.copy(ge).multiplyScalar(N).floor(),B.copy(Pe).multiplyScalar(N).floor(),W=je;if(H!==0&&(z=Sr),Z.bindFramebuffer(b.FRAMEBUFFER,z)&&V&&Z.drawBuffers(E,z),Z.viewport(L),Z.scissor(B),Z.setScissorTest(W),ce){const be=le.get(E.texture);b.framebufferTexture2D(b.FRAMEBUFFER,b.COLOR_ATTACHMENT0,b.TEXTURE_CUBE_MAP_POSITIVE_X+O,be.__webglTexture,H)}else if(Me){const be=O;for(let Ge=0;Ge<E.textures.length;Ge++){const We=le.get(E.textures[Ge]);b.framebufferTextureLayer(b.FRAMEBUFFER,b.COLOR_ATTACHMENT0+Ge,We.__webglTexture,H,be)}}else if(E!==null&&H!==0){const be=le.get(E.texture);b.framebufferTexture2D(b.FRAMEBUFFER,b.COLOR_ATTACHMENT0,b.TEXTURE_2D,be.__webglTexture,H)}T=-1},this.readRenderTargetPixels=function(E,O,H,V,z,ce,Me,Ie=0){if(!(E&&E.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let be=le.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&Me!==void 0&&(be=be[Me]),be){Z.bindFramebuffer(b.FRAMEBUFFER,be);try{const Ge=E.textures[Ie],We=Ge.format,Be=Ge.type;if(!K.textureFormatReadable(We)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!K.textureTypeReadable(Be)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}O>=0&&O<=E.width-V&&H>=0&&H<=E.height-z&&(E.textures.length>1&&b.readBuffer(b.COLOR_ATTACHMENT0+Ie),b.readPixels(O,H,V,z,Ce.convert(We),Ce.convert(Be),ce))}finally{const Ge=P!==null?le.get(P).__webglFramebuffer:null;Z.bindFramebuffer(b.FRAMEBUFFER,Ge)}}},this.readRenderTargetPixelsAsync=async function(E,O,H,V,z,ce,Me,Ie=0){if(!(E&&E.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let be=le.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&Me!==void 0&&(be=be[Me]),be)if(O>=0&&O<=E.width-V&&H>=0&&H<=E.height-z){Z.bindFramebuffer(b.FRAMEBUFFER,be);const Ge=E.textures[Ie],We=Ge.format,Be=Ge.type;if(!K.textureFormatReadable(We))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!K.textureTypeReadable(Be))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const nt=b.createBuffer();b.bindBuffer(b.PIXEL_PACK_BUFFER,nt),b.bufferData(b.PIXEL_PACK_BUFFER,ce.byteLength,b.STREAM_READ),E.textures.length>1&&b.readBuffer(b.COLOR_ATTACHMENT0+Ie),b.readPixels(O,H,V,z,Ce.convert(We),Ce.convert(Be),0);const ct=P!==null?le.get(P).__webglFramebuffer:null;Z.bindFramebuffer(b.FRAMEBUFFER,ct);const bt=b.fenceSync(b.SYNC_GPU_COMMANDS_COMPLETE,0);return b.flush(),await BS(b,bt,4),b.bindBuffer(b.PIXEL_PACK_BUFFER,nt),b.getBufferSubData(b.PIXEL_PACK_BUFFER,0,ce),b.deleteBuffer(nt),b.deleteSync(bt),ce}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(E,O=null,H=0){const V=Math.pow(2,-H),z=Math.floor(E.image.width*V),ce=Math.floor(E.image.height*V),Me=O!==null?O.x:0,Ie=O!==null?O.y:0;ve.setTexture2D(E,0),b.copyTexSubImage2D(b.TEXTURE_2D,H,0,0,Me,Ie,z,ce),Z.unbindTexture()};const Qr=b.createFramebuffer(),es=b.createFramebuffer();this.copyTextureToTexture=function(E,O,H=null,V=null,z=0,ce=null){ce===null&&(z!==0?(da("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),ce=z,z=0):ce=0);let Me,Ie,be,Ge,We,Be,nt,ct,bt;const vt=E.isCompressedTexture?E.mipmaps[ce]:E.image;if(H!==null)Me=H.max.x-H.min.x,Ie=H.max.y-H.min.y,be=H.isBox3?H.max.z-H.min.z:1,Ge=H.min.x,We=H.min.y,Be=H.isBox3?H.min.z:0;else{const On=Math.pow(2,-z);Me=Math.floor(vt.width*On),Ie=Math.floor(vt.height*On),E.isDataArrayTexture?be=vt.depth:E.isData3DTexture?be=Math.floor(vt.depth*On):be=1,Ge=0,We=0,Be=0}V!==null?(nt=V.x,ct=V.y,bt=V.z):(nt=0,ct=0,bt=0);const mt=Ce.convert(O.format),He=Ce.convert(O.type);let Et;O.isData3DTexture?(ve.setTexture3D(O,0),Et=b.TEXTURE_3D):O.isDataArrayTexture||O.isCompressedArrayTexture?(ve.setTexture2DArray(O,0),Et=b.TEXTURE_2D_ARRAY):(ve.setTexture2D(O,0),Et=b.TEXTURE_2D),b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL,O.flipY),b.pixelStorei(b.UNPACK_PREMULTIPLY_ALPHA_WEBGL,O.premultiplyAlpha),b.pixelStorei(b.UNPACK_ALIGNMENT,O.unpackAlignment);const at=b.getParameter(b.UNPACK_ROW_LENGTH),Mn=b.getParameter(b.UNPACK_IMAGE_HEIGHT),ts=b.getParameter(b.UNPACK_SKIP_PIXELS),En=b.getParameter(b.UNPACK_SKIP_ROWS),co=b.getParameter(b.UNPACK_SKIP_IMAGES);b.pixelStorei(b.UNPACK_ROW_LENGTH,vt.width),b.pixelStorei(b.UNPACK_IMAGE_HEIGHT,vt.height),b.pixelStorei(b.UNPACK_SKIP_PIXELS,Ge),b.pixelStorei(b.UNPACK_SKIP_ROWS,We),b.pixelStorei(b.UNPACK_SKIP_IMAGES,Be);const Tt=E.isDataArrayTexture||E.isData3DTexture,Fn=O.isDataArrayTexture||O.isData3DTexture;if(E.isDepthTexture){const On=le.get(E),nn=le.get(O),dn=le.get(On.__renderTarget),Bu=le.get(nn.__renderTarget);Z.bindFramebuffer(b.READ_FRAMEBUFFER,dn.__webglFramebuffer),Z.bindFramebuffer(b.DRAW_FRAMEBUFFER,Bu.__webglFramebuffer);for(let Mr=0;Mr<be;Mr++)Tt&&(b.framebufferTextureLayer(b.READ_FRAMEBUFFER,b.COLOR_ATTACHMENT0,le.get(E).__webglTexture,z,Be+Mr),b.framebufferTextureLayer(b.DRAW_FRAMEBUFFER,b.COLOR_ATTACHMENT0,le.get(O).__webglTexture,ce,bt+Mr)),b.blitFramebuffer(Ge,We,Me,Ie,nt,ct,Me,Ie,b.DEPTH_BUFFER_BIT,b.NEAREST);Z.bindFramebuffer(b.READ_FRAMEBUFFER,null),Z.bindFramebuffer(b.DRAW_FRAMEBUFFER,null)}else if(z!==0||E.isRenderTargetTexture||le.has(E)){const On=le.get(E),nn=le.get(O);Z.bindFramebuffer(b.READ_FRAMEBUFFER,Qr),Z.bindFramebuffer(b.DRAW_FRAMEBUFFER,es);for(let dn=0;dn<be;dn++)Tt?b.framebufferTextureLayer(b.READ_FRAMEBUFFER,b.COLOR_ATTACHMENT0,On.__webglTexture,z,Be+dn):b.framebufferTexture2D(b.READ_FRAMEBUFFER,b.COLOR_ATTACHMENT0,b.TEXTURE_2D,On.__webglTexture,z),Fn?b.framebufferTextureLayer(b.DRAW_FRAMEBUFFER,b.COLOR_ATTACHMENT0,nn.__webglTexture,ce,bt+dn):b.framebufferTexture2D(b.DRAW_FRAMEBUFFER,b.COLOR_ATTACHMENT0,b.TEXTURE_2D,nn.__webglTexture,ce),z!==0?b.blitFramebuffer(Ge,We,Me,Ie,nt,ct,Me,Ie,b.COLOR_BUFFER_BIT,b.NEAREST):Fn?b.copyTexSubImage3D(Et,ce,nt,ct,bt+dn,Ge,We,Me,Ie):b.copyTexSubImage2D(Et,ce,nt,ct,Ge,We,Me,Ie);Z.bindFramebuffer(b.READ_FRAMEBUFFER,null),Z.bindFramebuffer(b.DRAW_FRAMEBUFFER,null)}else Fn?E.isDataTexture||E.isData3DTexture?b.texSubImage3D(Et,ce,nt,ct,bt,Me,Ie,be,mt,He,vt.data):O.isCompressedArrayTexture?b.compressedTexSubImage3D(Et,ce,nt,ct,bt,Me,Ie,be,mt,vt.data):b.texSubImage3D(Et,ce,nt,ct,bt,Me,Ie,be,mt,He,vt):E.isDataTexture?b.texSubImage2D(b.TEXTURE_2D,ce,nt,ct,Me,Ie,mt,He,vt.data):E.isCompressedTexture?b.compressedTexSubImage2D(b.TEXTURE_2D,ce,nt,ct,vt.width,vt.height,mt,vt.data):b.texSubImage2D(b.TEXTURE_2D,ce,nt,ct,Me,Ie,mt,He,vt);b.pixelStorei(b.UNPACK_ROW_LENGTH,at),b.pixelStorei(b.UNPACK_IMAGE_HEIGHT,Mn),b.pixelStorei(b.UNPACK_SKIP_PIXELS,ts),b.pixelStorei(b.UNPACK_SKIP_ROWS,En),b.pixelStorei(b.UNPACK_SKIP_IMAGES,co),ce===0&&O.generateMipmaps&&b.generateMipmap(Et),Z.unbindTexture()},this.initRenderTarget=function(E){le.get(E).__webglFramebuffer===void 0&&ve.setupRenderTarget(E)},this.initTexture=function(E){E.isCubeTexture?ve.setTextureCube(E,0):E.isData3DTexture?ve.setTexture3D(E,0):E.isDataArrayTexture||E.isCompressedArrayTexture?ve.setTexture2DArray(E,0):ve.setTexture2D(E,0),Z.unbindTexture()},this.resetState=function(){C=0,A=0,P=null,Z.reset(),pe.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return pi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=lt._getDrawingBufferColorSpace(e),n.unpackColorSpace=lt._getUnpackColorSpace()}}const mg={type:"change"},qd={type:"start"},y0={type:"end"},Tl=new Ou,gg=new Ki,XA=Math.cos(70*kS.DEG2RAD),Ut=new I,pn=2*Math.PI,dt={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Zc=1e-6;class YA extends aE{constructor(e,n=null){super(e,n),this.state=dt.NONE,this.target=new I,this.cursor=new I,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Vs.ROTATE,MIDDLE:Vs.DOLLY,RIGHT:Vs.PAN},this.touches={ONE:Ns.ROTATE,TWO:Ns.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new I,this._lastQuaternion=new jr,this._lastTargetPosition=new I,this._quat=new jr().setFromUnitVectors(e.up,new I(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new Gm,this._sphericalDelta=new Gm,this._scale=1,this._panOffset=new I,this._rotateStart=new fe,this._rotateEnd=new fe,this._rotateDelta=new fe,this._panStart=new fe,this._panEnd=new fe,this._panDelta=new fe,this._dollyStart=new fe,this._dollyEnd=new fe,this._dollyDelta=new fe,this._dollyDirection=new I,this._mouse=new fe,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=qA.bind(this),this._onPointerDown=jA.bind(this),this._onPointerUp=$A.bind(this),this._onContextMenu=nR.bind(this),this._onMouseWheel=JA.bind(this),this._onKeyDown=QA.bind(this),this._onTouchStart=eR.bind(this),this._onTouchMove=tR.bind(this),this._onMouseDown=KA.bind(this),this._onMouseMove=ZA.bind(this),this._interceptControlDown=iR.bind(this),this._interceptControlUp=rR.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}connect(e){super.connect(e),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(mg),this.update(),this.state=dt.NONE}update(e=null){const n=this.object.position;Ut.copy(n).sub(this.target),Ut.applyQuaternion(this._quat),this._spherical.setFromVector3(Ut),this.autoRotate&&this.state===dt.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let i=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(i)&&isFinite(r)&&(i<-Math.PI?i+=pn:i>Math.PI&&(i-=pn),r<-Math.PI?r+=pn:r>Math.PI&&(r-=pn),i<=r?this._spherical.theta=Math.max(i,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(i+r)/2?Math.max(i,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let s=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const o=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),s=o!=this._spherical.radius}if(Ut.setFromSpherical(this._spherical),Ut.applyQuaternion(this._quatInverse),n.copy(this.target).add(Ut),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let o=null;if(this.object.isPerspectiveCamera){const a=Ut.length();o=this._clampDistance(a*this._scale);const l=a-o;this.object.position.addScaledVector(this._dollyDirection,l),this.object.updateMatrixWorld(),s=!!l}else if(this.object.isOrthographicCamera){const a=new I(this._mouse.x,this._mouse.y,0);a.unproject(this.object);const l=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),s=l!==this.object.zoom;const u=new I(this._mouse.x,this._mouse.y,0);u.unproject(this.object),this.object.position.sub(u).add(a),this.object.updateMatrixWorld(),o=Ut.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;o!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(o).add(this.object.position):(Tl.origin.copy(this.object.position),Tl.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Tl.direction))<XA?this.object.lookAt(this.target):(gg.setFromNormalAndCoplanarPoint(this.object.up,this.target),Tl.intersectPlane(gg,this.target))))}else if(this.object.isOrthographicCamera){const o=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),o!==this.object.zoom&&(this.object.updateProjectionMatrix(),s=!0)}return this._scale=1,this._performCursorZoom=!1,s||this._lastPosition.distanceToSquared(this.object.position)>Zc||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Zc||this._lastTargetPosition.distanceToSquared(this.target)>Zc?(this.dispatchEvent(mg),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e!==null?pn/60*this.autoRotateSpeed*e:pn/60/60*this.autoRotateSpeed}_getZoomScale(e){const n=Math.abs(e*.01);return Math.pow(.95,this.zoomSpeed*n)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,n){Ut.setFromMatrixColumn(n,0),Ut.multiplyScalar(-e),this._panOffset.add(Ut)}_panUp(e,n){this.screenSpacePanning===!0?Ut.setFromMatrixColumn(n,1):(Ut.setFromMatrixColumn(n,0),Ut.crossVectors(this.object.up,Ut)),Ut.multiplyScalar(e),this._panOffset.add(Ut)}_pan(e,n){const i=this.domElement;if(this.object.isPerspectiveCamera){const r=this.object.position;Ut.copy(r).sub(this.target);let s=Ut.length();s*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*s/i.clientHeight,this.object.matrix),this._panUp(2*n*s/i.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/i.clientWidth,this.object.matrix),this._panUp(n*(this.object.top-this.object.bottom)/this.object.zoom/i.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(e,n){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const i=this.domElement.getBoundingClientRect(),r=e-i.left,s=n-i.top,o=i.width,a=i.height;this._mouse.x=r/o*2-1,this._mouse.y=-(s/a)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const n=this.domElement;this._rotateLeft(pn*this._rotateDelta.x/n.clientHeight),this._rotateUp(pn*this._rotateDelta.y/n.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let n=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(pn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),n=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-pn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),n=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(pn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),n=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-pn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),n=!0;break}n&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{const n=this._getSecondPointerPosition(e),i=.5*(e.pageX+n.x),r=.5*(e.pageY+n.y);this._rotateStart.set(i,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{const n=this._getSecondPointerPosition(e),i=.5*(e.pageX+n.x),r=.5*(e.pageY+n.y);this._panStart.set(i,r)}}_handleTouchStartDolly(e){const n=this._getSecondPointerPosition(e),i=e.pageX-n.x,r=e.pageY-n.y,s=Math.sqrt(i*i+r*r);this._dollyStart.set(0,s)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{const i=this._getSecondPointerPosition(e),r=.5*(e.pageX+i.x),s=.5*(e.pageY+i.y);this._rotateEnd.set(r,s)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const n=this.domElement;this._rotateLeft(pn*this._rotateDelta.x/n.clientHeight),this._rotateUp(pn*this._rotateDelta.y/n.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{const n=this._getSecondPointerPosition(e),i=.5*(e.pageX+n.x),r=.5*(e.pageY+n.y);this._panEnd.set(i,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){const n=this._getSecondPointerPosition(e),i=e.pageX-n.x,r=e.pageY-n.y,s=Math.sqrt(i*i+r*r);this._dollyEnd.set(0,s),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const o=(e.pageX+n.x)*.5,a=(e.pageY+n.y)*.5;this._updateZoomParameters(o,a)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let n=0;n<this._pointers.length;n++)if(this._pointers[n]==e.pointerId){this._pointers.splice(n,1);return}}_isTrackingPointer(e){for(let n=0;n<this._pointers.length;n++)if(this._pointers[n]==e.pointerId)return!0;return!1}_trackPointer(e){let n=this._pointerPositions[e.pointerId];n===void 0&&(n=new fe,this._pointerPositions[e.pointerId]=n),n.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){const n=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[n]}_customWheelEvent(e){const n=e.deltaMode,i={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(n){case 1:i.deltaY*=16;break;case 2:i.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(i.deltaY*=10),i}}function jA(t){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(t.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(t)&&(this._addPointer(t),t.pointerType==="touch"?this._onTouchStart(t):this._onMouseDown(t)))}function qA(t){this.enabled!==!1&&(t.pointerType==="touch"?this._onTouchMove(t):this._onMouseMove(t))}function $A(t){switch(this._removePointer(t),this._pointers.length){case 0:this.domElement.releasePointerCapture(t.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(y0),this.state=dt.NONE;break;case 1:const e=this._pointers[0],n=this._pointerPositions[e];this._onTouchStart({pointerId:e,pageX:n.x,pageY:n.y});break}}function KA(t){let e;switch(t.button){case 0:e=this.mouseButtons.LEFT;break;case 1:e=this.mouseButtons.MIDDLE;break;case 2:e=this.mouseButtons.RIGHT;break;default:e=-1}switch(e){case Vs.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(t),this.state=dt.DOLLY;break;case Vs.ROTATE:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=dt.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=dt.ROTATE}break;case Vs.PAN:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=dt.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=dt.PAN}break;default:this.state=dt.NONE}this.state!==dt.NONE&&this.dispatchEvent(qd)}function ZA(t){switch(this.state){case dt.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(t);break;case dt.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(t);break;case dt.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(t);break}}function JA(t){this.enabled===!1||this.enableZoom===!1||this.state!==dt.NONE||(t.preventDefault(),this.dispatchEvent(qd),this._handleMouseWheel(this._customWheelEvent(t)),this.dispatchEvent(y0))}function QA(t){this.enabled!==!1&&this._handleKeyDown(t)}function eR(t){switch(this._trackPointer(t),this._pointers.length){case 1:switch(this.touches.ONE){case Ns.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(t),this.state=dt.TOUCH_ROTATE;break;case Ns.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(t),this.state=dt.TOUCH_PAN;break;default:this.state=dt.NONE}break;case 2:switch(this.touches.TWO){case Ns.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(t),this.state=dt.TOUCH_DOLLY_PAN;break;case Ns.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(t),this.state=dt.TOUCH_DOLLY_ROTATE;break;default:this.state=dt.NONE}break;default:this.state=dt.NONE}this.state!==dt.NONE&&this.dispatchEvent(qd)}function tR(t){switch(this._trackPointer(t),this.state){case dt.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(t),this.update();break;case dt.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(t),this.update();break;case dt.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(t),this.update();break;case dt.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(t),this.update();break;default:this.state=dt.NONE}}function nR(t){this.enabled!==!1&&t.preventDefault()}function iR(t){t.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function rR(t){t.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function _g(){return window.performance&&typeof performance.now=="function"&&typeof performance.timeOrigin=="number"?performance.timeOrigin+performance.now():Date.now()}const An={innerRadius:1,outerRadius:1.3,startAngle:50,endAngle:270},sR=264,on={startNote:"C",startOctave:3,endNote:"B",endOctave:4,rangeShift:0},wl=[{note:"C",ratio:1,name:"ド",isBlack:!1},{note:"C#",ratio:16/15,name:"ド#",isBlack:!0},{note:"D",ratio:9/8,name:"レ",isBlack:!1},{note:"D#",ratio:6/5,name:"レ#",isBlack:!0},{note:"E",ratio:5/4,name:"ミ",isBlack:!1},{note:"F",ratio:4/3,name:"フ",isBlack:!1},{note:"F#",ratio:45/32,name:"フ#",isBlack:!0},{note:"G",ratio:3/2,name:"ソ",isBlack:!1},{note:"G#",ratio:8/5,name:"ソ#",isBlack:!0},{note:"A",ratio:5/3,name:"ラ",isBlack:!1},{note:"A#",ratio:16/9,name:"ラ#",isBlack:!0},{note:"B",ratio:15/8,name:"シ",isBlack:!1}];function S0(t,e,n,i,r=0){const s=[],o=wl.findIndex(f=>f.note===t),a=wl.findIndex(f=>f.note===n);if(o===-1||a===-1)return console.error("Invalid note names"),s;const l=e+r,u=i+r;for(let f=l;f<=u;f++){const h=f-4,d=Math.pow(2,h);for(let p=0;p<wl.length;p++){if(f===l&&p<o)continue;if(f===u&&p>a)break;const g=wl[p];s.push({note:`${g.note}${f}`,freq:sR*g.ratio*d,name:g.name,isBlack:g.isBlack})}}return s}let Al=S0(on.startNote,on.startOctave,on.endNote,on.endOctave,on.rangeShift);class oR{constructor(){this.audioContext=null,this.oscillators=new Map,this.gainNodes=new Map,this.waveType="sawtooth",this.decayEnabled=!0,this.decayTime=2,this.noteStartTimes=new Map}init(){this.audioContext||(this.audioContext=new(window.AudioContext||window.webkitAudioContext))}setWaveType(e){this.waveType=e}setDecayEnabled(e){this.decayEnabled=e}updateDecay(){if(!this.decayEnabled||!this.audioContext)return;const e=this.audioContext.currentTime;for(const[n,i]of this.gainNodes.entries()){const r=this.noteStartTimes.get(n);if(r){const s=e-r;if(s<this.decayTime){const o=.3*Math.exp(-3*s/this.decayTime)+.05;i.gain.setValueAtTime(o,e)}else i.gain.setValueAtTime(.05,e)}}}playNote(e,n){if(this.init(),this.oscillators.has(n))return;const i=this.audioContext.createOscillator(),r=this.audioContext.createGain();i.type=this.waveType,i.frequency.setValueAtTime(e,this.audioContext.currentTime),r.gain.setValueAtTime(0,this.audioContext.currentTime),r.gain.linearRampToValueAtTime(.3,this.audioContext.currentTime+.01),i.connect(r),r.connect(this.audioContext.destination),i.start(),this.oscillators.set(n,i),this.gainNodes.set(n,r),this.noteStartTimes.set(n,this.audioContext.currentTime)}stopNote(e){const n=this.oscillators.get(e),i=this.gainNodes.get(e);n&&i&&(i.gain.linearRampToValueAtTime(0,this.audioContext.currentTime+.1),n.stop(this.audioContext.currentTime+.1),this.oscillators.delete(e),this.gainNodes.delete(e),this.noteStartTimes.delete(e))}stopAll(){for(const e of this.oscillators.keys())this.stopNote(e)}}const aR=()=>{const t=Ue.useRef(null),e=Ue.useRef(null),n=Ue.useRef(null),i=Ue.useRef(null),r=Ue.useRef(null),s=Ue.useRef(null),o=Ue.useRef(null),a=Ue.useRef(null),l=Ue.useRef(0),u=Ue.useRef([]),f=Ue.useRef(null),h=Ue.useRef([]),d=Ue.useRef([]),p=Ue.useRef([]),g=Ue.useRef(null),x=Ue.useRef(new Set),m=Ue.useRef(on.rangeShift),c=Ue.useRef(Al),v=Ue.useRef(An.innerRadius),_=Ue.useRef(An.outerRadius),y=Ue.useRef(.2),R=F=>{if(!g.current)return;const U=document.createElement("canvas"),he=U.getContext("2d");if(U.width=1024,U.height=512,he.fillStyle="rgba(0, 0, 0, 0)",he.fillRect(0,0,1024,512),F.length>0){he.textAlign="center",he.textBaseline="middle";const Ee=F.map(xe=>xe.note).join(", ");he.font="bold 50px Arial",he.shadowBlur=10,he.shadowOffsetX=3,he.shadowOffsetY=3,he.strokeStyle="rgba(0, 0, 0, 0.8)",he.lineWidth=5,he.strokeText(Ee,512,350),he.fillStyle="rgba(255, 255, 255, 0.9)",he.fillText(Ee,512,350)}const oe=new zc(U);g.current.material.map=oe,g.current.material.needsUpdate=!0},[C,A]=Ue.useState("disconnected"),[P,T]=Ue.useState(0),[M,L]=Ue.useState(0),[B,W]=Ue.useState(0),[te,X]=Ue.useState(!1),[Y,J]=Ue.useState({min:1/0,max:-1/0,avg:0,count:0}),[N,q]=Ue.useState(0),[Q,ge]=Ue.useState([]),[Pe,je]=Ue.useState(!1),[Fe,$e]=Ue.useState(on.rangeShift),[j,se]=Ue.useState("sawtooth"),[Te,Oe]=Ue.useState(!0),[Ae,Je]=Ue.useState(!1),[rt,b]=Ue.useState(!1),[ne,ee]=Ue.useState(!1),[K,Z]=Ue.useState(An.innerRadius),[_e,le]=Ue.useState(An.outerRadius),[ve,Xe]=Ue.useState(.2),Ve=Ue.useRef(Ae),w=Ue.useRef(rt),S=Ue.useRef(ne);Ue.useEffect(()=>{Ve.current=Ae},[Ae]),Ue.useEffect(()=>{w.current=rt},[rt]),Ue.useEffect(()=>{S.current=ne},[ne]),Ue.useEffect(()=>{v.current=K},[K]),Ue.useEffect(()=>{_.current=_e},[_e]),Ue.useEffect(()=>{y.current=ve},[ve]);const k=Ue.useCallback(()=>{const F=e.current;if(!F)return;const{startAngle:U,endAngle:he}=An,oe=v.current,Ee=_.current,xe=he-U,ie=c.current,de=xe/ie.length,Le=[],Ce=[],pe=[];ie.forEach((De,D)=>{const ae=U+D*de,me=ae+de,ye=(ae-90)*Math.PI/180,re=(me-90)*Math.PI/180,$=De.isBlack?(oe+Ee)/2:oe,we=Ee,ze=new l0,tt=32;for(let hn=0;hn<=tt;hn++){const uo=hn/tt,Sr=ye+(re-ye)*uo,Qr=Math.cos(Sr)*we,es=Math.sin(Sr)*we;hn===0?ze.moveTo(Qr,es):ze.lineTo(Qr,es)}for(let hn=tt;hn>=0;hn--){const uo=hn/tt,Sr=ye+(re-ye)*uo,Qr=Math.cos(Sr)*$,es=Math.sin(Sr)*$;ze.lineTo(Qr,es)}ze.closePath();const Qe={depth:De.isBlack?.03:.02,bevelEnabled:!0,bevelThickness:.002,bevelSize:.002,bevelSegments:2},Ye=new Yd(ze,Qe),ke=new QM({color:De.isBlack?3355443:16777215,emissive:0,metalness:.1,roughness:.4}),ot=new mi(Ye,ke);ot.rotation.x=-Math.PI/2,ot.position.y=De.isBlack?.02:.01,F.add(ot),Le.push(ot);const qt=new xM(Ye,15),tn=new e0({color:De.isBlack?6710886:8947848,linewidth:2}),Un=new _M(qt,tn);ot.add(Un);const pt=document.createElement("canvas"),_t=pt.getContext("2d");pt.width=512,pt.height=256,_t.textAlign="center",_t.textBaseline="middle",_t.font="bold 120px Arial",_t.shadowColor="rgba(0, 0, 0, 0.8)",_t.shadowBlur=10,_t.shadowOffsetX=4,_t.shadowOffsetY=4,_t.strokeStyle=De.isBlack?"rgba(0, 0, 0, 0.9)":"rgba(255, 255, 255, 0.9)",_t.lineWidth=20,_t.strokeText(De.note,256,128),_t.fillStyle=De.isBlack?"rgba(255, 255, 255, 0.95)":"rgba(0, 0, 0, 0.9)",_t.fillText(De.note,256,128);const Wt=new zc(pt),qn=new Uh({map:Wt,transparent:!0}),$n=new bm(qn),yr=(ye+re)/2,lo=($+we)/2;$n.position.x=Math.cos(yr)*lo,$n.position.y=De.isBlack?.08:.07,$n.position.z=-Math.sin(yr)*lo,$n.scale.set(.2,.1,1),F.add($n),pe.push($n)}),h.current=Le,d.current=Ce,p.current=pe},[]);Ue.useEffect(()=>{m.current=Fe;const F=S0(on.startNote,on.startOctave,on.endNote,on.endOctave,Fe);c.current=F,Al=F,console.log(`Range shifted to ${Fe}: ${F.length} notes, from ${F[0].note} to ${F[F.length-1].note}`),e.current&&(h.current.forEach(U=>{U.geometry&&U.geometry.dispose(),U.material&&U.material.dispose(),e.current.remove(U)}),d.current.forEach(U=>{U.geometry&&U.geometry.dispose(),U.material&&U.material.dispose(),e.current.remove(U)}),p.current.forEach(U=>{U.geometry&&U.geometry.dispose(),U.material&&(U.material.map&&U.material.map.dispose(),U.material.dispose()),e.current.remove(U)}),h.current=[],d.current=[],p.current=[],k())},[Fe,k]),Ue.useEffect(()=>{e.current&&(h.current.forEach(F=>{F.geometry&&F.geometry.dispose(),F.material&&F.material.dispose(),e.current.remove(F)}),d.current.forEach(F=>{F.geometry&&F.geometry.dispose(),F.material&&F.material.dispose(),e.current.remove(F)}),p.current.forEach(F=>{F.geometry&&F.geometry.dispose(),F.material&&(F.material.map&&F.material.map.dispose(),F.material.dispose()),e.current.remove(F)}),h.current=[],d.current=[],p.current=[],k())},[K,_e,k]),Ue.useEffect(()=>{f.current&&f.current.setDecayEnabled(Te)},[Te]),Ue.useEffect(()=>{R(Q)},[Q]);const G=()=>{f.current&&f.current.audioContext&&f.current.audioContext.resume().then(()=>{console.log("AudioContext resumed"),je(!0)})};return Ue.useEffect(()=>{f.current||(f.current=new oR,console.log("PianoSynth initialized"));const U=`ws://${window.location.hostname||"192.168.4.1"}:81/`;console.log("Connecting to WebSocket:",U),A("connecting");const he=new WebSocket(U);he.binaryType="arraybuffer",s.current=he,he.onopen=()=>{console.log("WebSocket connected"),A("connected"),l.current=0,u.current=[],J({min:1/0,max:-1/0,avg:0,count:0}),o.current=setInterval(()=>{if(s.current&&s.current.readyState===WebSocket.OPEN){l.current++;const xe={type:"ping",id:l.current,t:_g()};s.current.send(JSON.stringify(xe)),a.current&&clearTimeout(a.current),a.current=setTimeout(()=>{console.warn("Ping timeout (3000ms) - Reloading page..."),window.location.reload()},3e3)}},1e3),X(!0)},he.onclose=xe=>{console.log("WebSocket closed:",xe.code,xe.reason),A("disconnected")},he.onerror=xe=>{console.error("WebSocket error:",xe),A("error")};let oe=0,Ee=Date.now();return he.onmessage=xe=>{if(xe.data instanceof ArrayBuffer){const ie=new Uint8Array(xe.data),de=ie[0],Le=new Uint16Array(ie.buffer,2,1)[0],Ce=new Uint32Array(ie.buffer,4,1)[0];if(de!==1||Le!==360){console.warn("Invalid LiDAR data format");return}const pe=new Float32Array(ie.buffer,8,Le),De=new Float32Array(360);for(let Ye=0;Ye<360;Ye++){let ke=Ye;S.current&&(ke=(ke+180)%360),Ve.current&&(ke=(360-ke)%360),w.current&&(ke=(180-ke+360)%360),De[Ye]=pe[ke]}if(i.current){const Ye=i.current.geometry.attributes.position.array,ke=i.current.geometry.attributes.color.array,ot=An.startAngle,qt=An.endAngle,tn=v.current,Un=_.current;for(let pt=0;pt<360;pt++){const _t=pt*Math.PI/180,Wt=De[pt];Ye[pt*3]=-Math.cos(_t)*Wt,Ye[pt*3+1]=.1,Ye[pt*3+2]=Math.sin(_t)*Wt;const qn=pt-90,$n=qn>=ot&&qn<=qt,yr=Wt>=tn&&Wt<=Un;if($n&&yr)ke[pt*3]=1,ke[pt*3+1]=1,ke[pt*3+2]=0;else{const hn=Math.min(Wt/3,1);ke[pt*3]=hn*.3,ke[pt*3+1]=hn*.3,ke[pt*3+2]=hn*.5}}i.current.geometry.attributes.position.needsUpdate=!0,i.current.geometry.attributes.color.needsUpdate=!0}const D=[],ae=An.startAngle,me=An.endAngle,ye=v.current,re=_.current,$=c.current,ze=(me-ae)/$.length,tt=y.current;for(let Ye=0;Ye<360;Ye++){const ke=Ye-90,ot=De[Ye];if(ke>=ae&&ke<=me&&ot>=ye&&ot<=re){const qt=ke-ae,tn=Math.floor(qt/ze);if(tn>=0&&tn<$.length){const Un=(qt-tn*ze)/ze,pt=tt/2;if(Un>=pt&&Un<=1-pt){const _t=$[tn];D.find(Wt=>Wt.note===_t.note)||D.push(_t)}}}}if(f.current){D.forEach(ke=>{x.current.has(ke.note)||(console.log(`Playing: ${ke.note}, freq: ${ke.freq.toFixed(2)}Hz`),f.current.playNote(ke.freq,ke.note),x.current.add(ke.note))});const Ye=new Set(D.map(ke=>ke.note));for(const ke of x.current)Ye.has(ke)||(f.current.stopNote(ke),x.current.delete(ke))}h.current.forEach((Ye,ke)=>{const ot=Al[ke],qt=D.some(Wt=>Wt.note===ot.note),tn=ot.isBlack?.02:.01,Un=ot.isBlack?-.01:-.02,pt=ot.isBlack?.021:.011,_t=ot.isBlack?-.009:-.019;if(qt){if(Ye.material.color.setHex(16776960),Ye.material.emissive.setHex(16746496),Ye.position.y=Un,d.current[ke]&&(d.current[ke].position.y=_t),p.current[ke]){const qn=(ot.isBlack?.08:.07)-tn;p.current[ke].position.y=Un+qn}}else if(ot.isBlack?(Ye.material.color.setHex(3355443),Ye.material.emissive.setHex(0)):(Ye.material.color.setHex(16777215),Ye.material.emissive.setHex(0)),Ye.position.y=tn,d.current[ke]&&(d.current[ke].position.y=pt),p.current[ke]){const Wt=ot.isBlack?.08:.07;p.current[ke].position.y=Wt}}),ge(D),oe++,T(Ye=>Ye+1),W(Ce);const Qe=Date.now();Qe-Ee>=1e3&&(L(oe),oe=0,Ee=Qe)}else if(typeof xe.data=="string")try{const ie=JSON.parse(xe.data);if(ie.type==="ping"){a.current&&(clearTimeout(a.current),a.current=null);const de=_g(),Le=de-ie.t;q(Le),u.current.push({timestamp:de,rtt:Le});const Ce=de-3e4;if(u.current=u.current.filter(pe=>pe.timestamp>=Ce),u.current.length>0){const pe=u.current.map(re=>re.rtt),De=Math.min(...pe),D=Math.max(...pe),me=pe.reduce((re,$)=>re+$,0)/pe.length,ye=pe.length;J({min:De,max:D,avg:me,count:ye})}}}catch(ie){console.warn("Invalid JSON from server",ie)}},()=>{console.log("Cleaning up WebSocket"),o.current&&clearInterval(o.current),a.current&&clearTimeout(a.current),(he.readyState===WebSocket.OPEN||he.readyState===WebSocket.CONNECTING)&&he.close(),f.current&&f.current.stopAll()}},[]),Ue.useEffect(()=>{if(!t.current)return;const F=new fM;F.background=new it(0),e.current=F;const U=new Vn(75,t.current.clientWidth/t.current.clientHeight,.1,1e3),oe=((An.startAngle+An.endAngle)/2-90)*Math.PI/180,Ee=1.5,xe=-1.5,ie=.8;U.position.set(-Math.cos(oe)*xe,Ee,Math.sin(oe)*xe),U.lookAt(-Math.cos(oe)*ie,0,Math.sin(oe)*ie);const de=new WA({antialias:!0});de.setSize(t.current.clientWidth,t.current.clientHeight),de.setPixelRatio(window.devicePixelRatio),t.current.appendChild(de.domElement),n.current=de;const Le=new YA(U,de.domElement);Le.enableDamping=!0,Le.dampingFactor=.05,Le.target.set(0,0,0),Le.update(),k();const Ce=new sE(16777215,1.6);F.add(Ce);const pe=new rE(16777215,.8);pe.position.set(5,10,5),F.add(pe);const De=document.createElement("canvas"),D=De.getContext("2d");De.width=1024,De.height=512,D.fillStyle="rgba(0, 0, 0, 0)",D.fillRect(0,0,1024,512);const ae=new zc(De),me=new Uh({map:ae,transparent:!0,depthTest:!1,depthWrite:!1}),ye=new bm(me);ye.position.set(0,.2,0),ye.scale.set(1.5,.75,1),F.add(ye),g.current=ye;const re=new In,$=new Float32Array(360*3),we=new Float32Array(360*3),ze=new Float32Array(360);for(let ot=0;ot<360;ot++)$[ot*3]=0,$[ot*3+1]=0,$[ot*3+2]=0,we[ot*3]=1,we[ot*3+1]=0,we[ot*3+2]=.5,ze[ot]=1;re.setAttribute("position",new Sn($,3)),re.setAttribute("color",new Sn(we,3)),re.setAttribute("alpha",new Sn(ze,1));const tt=new t0({size:.02,vertexColors:!0,sizeAttenuation:!0,transparent:!0,opacity:1}),Qe=new vM(re,tt);F.add(Qe),i.current=Qe;const Ye=()=>{r.current=requestAnimationFrame(Ye),Le.update(),f.current&&f.current.updateDecay(),de.render(F,U)};Ye();const ke=()=>{t.current&&(U.aspect=t.current.clientWidth/t.current.clientHeight,U.updateProjectionMatrix(),de.setSize(t.current.clientWidth,t.current.clientHeight))};return window.addEventListener("resize",ke),()=>{window.removeEventListener("resize",ke),r.current&&cancelAnimationFrame(r.current),n.current&&t.current&&t.current.removeChild(n.current.domElement),re.dispose(),tt.dispose(),de.dispose()}},[]),Ne.jsxs("div",{style:{width:"100%",height:"100vh"},onClick:G,children:[Ne.jsx("div",{ref:t,style:{width:"100%",height:"100%",position:"relative"}}),Ne.jsxs("div",{style:{position:"absolute",top:"20px",left:"50%",transform:"translateX(-50%)",textAlign:"center",pointerEvents:"none"},children:[Ne.jsx("div",{style:{fontSize:"100px",fontWeight:"bold",fontFamily:"serif",background:"linear-gradient(135deg, #FFD700 0%, #FFA500 50%, #FF6347 100%)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",backgroundClip:"text",textShadow:"0 0 20px rgba(255, 215, 0, 0.5)",filter:"drop-shadow(0 4px 8px rgba(0, 0, 0, 0.8)) drop-shadow(0 0 15px rgba(255, 215, 0, 0.4))",letterSpacing:"8px",padding:"10px 20px"},children:"ピアノ"}),Ne.jsx("div",{style:{fontSize:"30px",color:"rgba(255, 255, 255, 0.9)",fontWeight:"bold",textShadow:"0 2px 4px rgba(0, 0, 0, 0.8)",marginTop:"-10px",letterSpacing:"4px"},children:"LiDAR FOOT PIANO"})]}),Ne.jsxs("div",{style:{position:"absolute",top:10,left:10,color:"white",background:"rgba(0, 0, 0, 0.7)",padding:"10px",borderRadius:"5px",fontFamily:"monospace",fontSize:"14px"},children:[Ne.jsx("div",{style:{fontSize:"16px",fontWeight:"bold",marginBottom:"8px"},children:"🎯 SonicRing"}),Ne.jsxs("div",{children:["WebSocket: ",Ne.jsx("span",{style:{color:C==="connected"?"#0f0":"#f00"},children:C})]}),Ne.jsx("div",{children:"Points: 360 (1° resolution)"}),Ne.jsxs("div",{children:["Update Rate: ",M," Hz"]}),Ne.jsxs("div",{children:["Frame Count: ",P]}),Ne.jsxs("div",{children:["Timestamp: ",B," ms"]}),Ne.jsxs("div",{style:{marginTop:"10px",paddingTop:"10px",borderTop:"1px solid rgba(255,255,255,0.3)"},children:[Ne.jsx("div",{style:{fontSize:"14px",fontWeight:"bold",marginBottom:"5px"},children:"📡 WebSocket Ping"}),Ne.jsxs("div",{children:["RTT: ",N.toFixed(2)," ms"]}),Ne.jsxs("div",{children:["Min: ",Y.min===1/0?"-":Y.min.toFixed(2)," ms"]}),Ne.jsxs("div",{children:["Max: ",Y.max===-1/0?"-":Y.max.toFixed(2)," ms"]}),Ne.jsxs("div",{children:["Avg: ",Y.count>0?Y.avg.toFixed(2):"-"," ms"]}),Ne.jsxs("div",{children:["Count: ",Y.count]})]}),Ne.jsx("div",{style:{marginTop:"10px",fontSize:"12px",opacity:.8},children:"Controls: Mouse to rotate, scroll to zoom"}),Ne.jsxs("div",{style:{marginTop:"10px",fontSize:"12px",color:Pe?"#0f0":"#ff0",fontWeight:"bold"},children:["🔊 Audio: ",Pe?"Enabled":"Click to enable"]})]}),Ne.jsxs("div",{style:{position:"absolute",top:10,right:10,color:"white",background:"rgba(0, 0, 0, 0.7)",padding:"10px",borderRadius:"5px",fontFamily:"monospace",fontSize:"12px"},children:[Ne.jsx("div",{style:{fontSize:"14px",fontWeight:"bold",marginBottom:"8px"},children:"🎹 ピアノペダル設定"}),Ne.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"6px"},children:[Ne.jsxs("div",{children:["内側半径: ",Ne.jsxs("strong",{children:[K.toFixed(2)," m"]})]}),Ne.jsx("input",{type:"range",min:.1,max:3,step:.01,value:K,onChange:F=>{F.stopPropagation();const U=parseFloat(F.target.value),he=Math.max(_e,U+.01);Z(U),le(he),v.current=U,_.current=he}}),Ne.jsxs("div",{children:["外側半径: ",Ne.jsxs("strong",{children:[_e.toFixed(2)," m"]})]}),Ne.jsx("input",{type:"range",min:.11,max:4,step:.01,value:_e,onChange:F=>{F.stopPropagation();let U=parseFloat(F.target.value);U<=K&&(U=K+.01),le(U),_.current=U}}),Ne.jsxs("div",{children:["開始角度: ",An.startAngle,"°"]}),Ne.jsxs("div",{children:["終了角度: ",An.endAngle,"°"]}),Ne.jsxs("div",{children:["鍵盤境界除外割合: ",Ne.jsxs("strong",{children:[(ve*100).toFixed(0),"%"]})]}),Ne.jsx("input",{type:"range",min:0,max:.5,step:.01,value:ve,onChange:F=>{F.stopPropagation();const U=parseFloat(F.target.value);Xe(U),y.current=U}})]}),Ne.jsxs("div",{style:{marginTop:"8px",paddingTop:"8px",borderTop:"1px solid rgba(255,255,255,0.3)"},children:["鍵盤数: ",Al.length]}),Ne.jsxs("div",{children:["演奏中: ",Q.length," 音"]}),Ne.jsxs("div",{style:{marginTop:"12px",paddingTop:"12px",borderTop:"1px solid rgba(255,255,255,0.3)"},children:[Ne.jsx("div",{style:{fontSize:"14px",fontWeight:"bold",marginBottom:"8px"},children:"🎹 音域シフト"}),Ne.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"10px"},children:[Ne.jsx("button",{onClick:F=>{F.stopPropagation();const U=Math.max(Fe-1,-2);$e(U),f.current&&(f.current.stopAll(),x.current.clear())},disabled:Fe<=-2,style:{padding:"8px 16px",fontSize:"18px",fontWeight:"bold",background:Fe<=-2?"#444":"#cc6600",color:"white",border:"none",borderRadius:"5px",cursor:Fe<=-2?"not-allowed":"pointer",opacity:Fe<=-2?.5:1},children:"−"}),Ne.jsxs("div",{style:{fontSize:"18px",fontWeight:"bold",minWidth:"60px",textAlign:"center",color:Fe===0?"#0f0":"#ffa500"},children:[Fe>0?"+":"",Fe]}),Ne.jsx("button",{onClick:F=>{F.stopPropagation();const U=Math.min(Fe+1,2);$e(U),f.current&&(f.current.stopAll(),x.current.clear())},disabled:Fe>=2,style:{padding:"8px 16px",fontSize:"18px",fontWeight:"bold",background:Fe>=2?"#444":"#cc6600",color:"white",border:"none",borderRadius:"5px",cursor:Fe>=2?"not-allowed":"pointer",opacity:Fe>=2?.5:1},children:"+"})]}),Ne.jsxs("div",{style:{fontSize:"10px",marginTop:"5px",opacity:.7},children:["範囲: ",on.startNote,on.startOctave+Fe," 〜 ",on.endNote,on.endOctave+Fe," (",c.current.length,"音)"]})]}),Ne.jsxs("div",{style:{marginTop:"12px",paddingTop:"12px",borderTop:"1px solid rgba(255,255,255,0.3)"},children:[Ne.jsx("div",{style:{fontSize:"14px",fontWeight:"bold",marginBottom:"8px"},children:"🎵 波形タイプ"}),Ne.jsx("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"5px"},children:["sine","triangle","sawtooth","square"].map(F=>Ne.jsx("button",{onClick:U=>{U.stopPropagation(),se(F),f.current&&(f.current.setWaveType(F),f.current.stopAll(),x.current.clear())},style:{padding:"6px 10px",fontSize:"11px",fontWeight:"bold",background:j===F?"#00cc00":"#0066cc",color:"white",border:"none",borderRadius:"4px",cursor:"pointer",opacity:j===F?1:.7},children:F==="sine"?"サイン波":F==="triangle"?"三角波":F==="sawtooth"?"ノコギリ波":"矩形波"},F))})]}),Ne.jsxs("div",{style:{marginTop:"12px",paddingTop:"12px",borderTop:"1px solid rgba(255,255,255,0.3)"},children:[Ne.jsx("div",{style:{fontSize:"14px",fontWeight:"bold",marginBottom:"8px"},children:"📉 音の減衰"}),Ne.jsx("button",{onClick:F=>{F.stopPropagation(),Oe(!Te)},style:{padding:"8px 16px",fontSize:"12px",fontWeight:"bold",background:Te?"#00cc00":"#666666",color:"white",border:"none",borderRadius:"5px",cursor:"pointer",width:"100%"},children:Te?"✅ ON (時間経過で減衰)":"❌ OFF (一定音量)"})]}),Ne.jsxs("div",{style:{marginTop:"12px",paddingTop:"12px",borderTop:"1px solid rgba(255,255,255,0.3)"},children:[Ne.jsx("div",{style:{fontSize:"14px",fontWeight:"bold",marginBottom:"8px"},children:"🔄 回転・反転"}),Ne.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"5px"},children:[Ne.jsxs("button",{onClick:F=>{F.stopPropagation();const U=!Ae;Je(U),Ve.current=U},style:{padding:"6px 10px",fontSize:"11px",fontWeight:"bold",background:Ae?"#cc6600":"#0066cc",color:"white",border:"none",borderRadius:"4px",cursor:"pointer",opacity:Ae?1:.7},children:["↔️ 左右反転 ",Ae?"ON":"OFF"]}),Ne.jsxs("button",{onClick:F=>{F.stopPropagation();const U=!rt;b(U),w.current=U},style:{padding:"6px 10px",fontSize:"11px",fontWeight:"bold",background:rt?"#cc6600":"#0066cc",color:"white",border:"none",borderRadius:"4px",cursor:"pointer",opacity:rt?1:.7},children:["↕️ 上下反転 ",rt?"ON":"OFF"]}),Ne.jsxs("button",{onClick:F=>{F.stopPropagation();const U=!ne;ee(U),S.current=U},style:{padding:"6px 10px",fontSize:"11px",fontWeight:"bold",background:ne?"#cc6600":"#0066cc",color:"white",border:"none",borderRadius:"4px",cursor:"pointer",opacity:ne?1:.7},children:["🔃 180°回転 ",ne?"ON":"OFF"]})]})]})]})]})};function lR(){return Ne.jsx("div",{style:{width:"100vw",height:"100vh",margin:0,padding:0},children:Ne.jsx(aR,{})})}Jc.createRoot(document.getElementById("root")).render(Ne.jsx(k0.StrictMode,{children:Ne.jsx(lR,{})}));
